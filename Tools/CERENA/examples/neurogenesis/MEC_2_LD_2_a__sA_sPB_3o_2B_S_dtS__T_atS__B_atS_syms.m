% function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_dtS__T_atS__B_atS_syms(f0_user)
function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_dtS__T_atS__B_atS_syms(varargin)
...
syms r_act2 r_inact r_div p_diffAS r_B_N r_death p_D0 p_Q0 
...
p = [r_act2,r_inact,r_div,p_diffAS,r_B_N,r_death,p_D0,p_Q0];
...
xdot(5) = 0.55*mu_4*r_div;
xdot(6) = 0.45*mu_4*r_div - mu_6*r_B_N + mu_5*r_div;
...
xdot(12) = 0.55*C_1_4*r_div - C_1_5/5000;
xdot(13) = 0.45*C_1_4*r_div - C_1_6*r_B_N - C_1_6/5000 + C_1_5*r_div;
...
xdot(18) = C_1_5/5000 - C_2_5*r_act2 + 0.55*C_2_4*r_div + C_3_5*r_inact;
xdot(19) = C_1_6/5000 - C_2_6*r_B_N - C_2_6*r_act2 + 0.45*C_2_4*r_div + C_2_5*r_div + C_3_6*r_inact;
...
xdot(23) = C_2_5*r_act2 + 0.55*C_3_4*r_div - C_3_5*r_inact + C_3_5*r_div*(p_diffAS - 1)^2 - C_3_5*p_diffAS^2*r_div;
xdot(24) = C_2_6*r_act2 - C_3_6*r_B_N + 0.45*C_3_4*r_div + C_3_5*r_div - C_3_6*r_inact + C_3_6*r_div*(p_diffAS - 1)^2 - C_3_6*p_diffAS^2*r_div;
...
xdot(27) = 0.55*C_4_4*r_div + 2*C_3_5*p_diffAS^2*r_div - 2*C_3_5*p_diffAS*r_div*(p_diffAS - 1);
xdot(28) = 0.45*C_4_4*r_div - C_4_6*r_B_N + C_4_5*r_div + 2*C_3_6*p_diffAS^2*r_div - 2*C_3_6*p_diffAS*r_div*(p_diffAS - 1);
xdot(29) = C_4_6*r_B_N - C_4_7*r_death + 2*C_3_7*p_diffAS^2*r_div - 2*C_3_7*p_diffAS*r_div*(p_diffAS - 1);
xdot(30) = 1.1*C_4_5*r_div + 0.55*mu_4*r_div;
xdot(31) = 0.45*C_4_5*r_div - C_5_6*r_B_N + 0.55*C_4_6*r_div + C_5_5*r_div;
xdot(32) = C_5_6*r_B_N + 0.55*C_4_7*r_div - C_5_7*r_death;
xdot(33) = 0.9*C_4_6*r_div - 2*C_6_6*r_B_N + 2*C_5_6*r_div + mu_6*r_B_N + 0.45*mu_4*r_div + mu_5*r_div;
xdot(34) = C_6_6*r_B_N - C_6_7*r_B_N + 0.45*C_4_7*r_div + C_5_7*r_div - C_6_7*r_death - mu_6*r_B_N;
