% function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_atS__T_atS__B_astS_syms(f0_user)
function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_atS__T_atS__B_astS_syms(varargin)
...
syms r_act2 r_inact r_div pB1_B1B1 pB1_B2B2 r_B_N r_death p_D0 p_Q0 
...
p = [r_act2,r_inact,r_div,pB1_B1B1,pB1_B2B2,r_B_N,r_death,p_D0,p_Q0];
...
xdot(11) = C_1_3*r_div - C_1_4/5000;
...
xdot(17) = C_1_4/5000 - C_2_4*r_act2 + C_2_3*r_div + C_3_4*r_inact;
...
xdot(22) = C_2_4*r_act2 + C_3_3*r_div - C_3_4*r_inact;
xdot(23) = C_2_5*r_act2 + 0.55*C_3_4*r_div - C_3_5*r_inact + C_3_5*pB1_B1B1*r_div - C_3_5*pB1_B2B2*r_div;
xdot(24) = C_2_6*r_act2 - C_3_6*r_B_N + 0.45*C_3_4*r_div - C_3_6*r_inact - C_3_5*r_div*(pB1_B1B1 + pB1_B2B2 - 1) + 2*C_3_5*pB1_B2B2*r_div;
xdot(25) = C_3_6*r_B_N + C_2_7*r_act2 - C_3_7*r_death - C_3_7*r_inact;
xdot(26) = 2*C_3_4*r_div + mu_3*r_div;
xdot(27) = C_3_5*r_div + 0.55*C_4_4*r_div + C_4_5*pB1_B1B1*r_div - C_4_5*pB1_B2B2*r_div;
xdot(28) = C_3_6*r_div - C_4_6*r_B_N + 0.45*C_4_4*r_div - C_4_5*r_div*(pB1_B1B1 + pB1_B2B2 - 1) + 2*C_4_5*pB1_B2B2*r_div;
xdot(29) = C_4_6*r_B_N + C_3_7*r_div - C_4_7*r_death;
