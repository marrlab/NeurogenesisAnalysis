% function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_astS__T_dtS__B_atS_syms(f0_user)
function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_astS__T_dtS__B_atS_syms(varargin)
...
syms r_act2 r_inact r_div pAS_ASAS pAS_TT p_diffT r_B_N r_death p_D0 p_Q0 
...
p = [r_act2,r_inact,r_div,pAS_ASAS,pAS_TT,p_diffT,r_B_N,r_death,p_D0,p_Q0];
...
xdot(23) = C_2_5*r_act2 - C_3_5*r_inact - C_3_5*pAS_TT*r_div + C_3_5*pAS_ASAS*r_div + 1.1*C_3_4*p_diffT^2*r_div - 1.1*C_3_4*p_diffT*r_div*(p_diffT - 1);
xdot(24) = C_2_6*r_act2 - C_3_6*r_B_N + C_3_5*r_div - C_3_6*r_inact - C_3_6*pAS_TT*r_div + C_3_6*pAS_ASAS*r_div + 0.9*C_3_4*p_diffT^2*r_div - 0.9*C_3_4*p_diffT*r_div*(p_diffT - 1);
...
xdot(27) = C_4_5*r_div*(p_diffT - 1)^2 - 1.1*mu_4*p_diffT^2*r_div - C_3_5*r_div*(pAS_TT + pAS_ASAS - 1) + 2*C_3_5*pAS_TT*r_div + 1.1*C_4_4*p_diffT^2*r_div - 1.0*C_4_5*p_diffT^2*r_div - 1.1*C_4_4*p_diffT*r_div*(p_diffT - 1);
xdot(28) = C_4_5*r_div - C_4_6*r_B_N - 0.9*mu_4*p_diffT^2*r_div + C_4_6*r_div*(p_diffT - 1)^2 - C_3_6*r_div*(pAS_TT + pAS_ASAS - 1) + 2*C_3_6*pAS_TT*r_div + 0.9*C_4_4*p_diffT^2*r_div - 1.0*C_4_6*p_diffT^2*r_div - 0.9*C_4_4*p_diffT*r_div*(p_diffT - 1);
