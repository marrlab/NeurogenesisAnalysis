% function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_atS__T_stS__B_stS_syms(f0_user)
function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_atS__T_stS__B_stS_syms(varargin)
...
syms r_act2 r_inact r_div pT_TT pB1_B1B1 r_B_N r_death p_D0 p_Q0 
...
p = [r_act2,r_inact,r_div,pT_TT,pB1_B1B1,r_B_N,r_death,p_D0,p_Q0];
...
xdot(23) = C_2_5*r_act2 - C_3_5*r_inact + C_3_5*pB1_B1B1*r_div + C_3_5*r_div*(pB1_B1B1 - 1) - 1.1*C_3_4*r_div*(pT_TT - 1);
xdot(24) = C_2_6*r_act2 - C_3_6*r_B_N - C_3_6*r_inact - 2*C_3_5*r_div*(pB1_B1B1 - 1) - 0.9*C_3_4*r_div*(pT_TT - 1);
...
xdot(27) = C_3_5*r_div + 1.1*mu_4*r_div*(pT_TT - 1) + C_4_5*pB1_B1B1*r_div + C_4_5*pT_TT*r_div + C_4_5*r_div*(pB1_B1B1 - 1) - 1.1*C_4_4*r_div*(pT_TT - 1) + 1.0*C_4_5*r_div*(pT_TT - 1);
xdot(28) = C_3_6*r_div - C_4_6*r_B_N + 0.9*mu_4*r_div*(pT_TT - 1) + C_4_6*pT_TT*r_div - 2*C_4_5*r_div*(pB1_B1B1 - 1) - 0.9*C_4_4*r_div*(pT_TT - 1) + 1.0*C_4_6*r_div*(pT_TT - 1);
