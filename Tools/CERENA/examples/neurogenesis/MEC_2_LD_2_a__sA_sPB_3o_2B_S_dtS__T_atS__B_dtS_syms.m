% function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_dtS__T_atS__B_dtS_syms(f0_user)
function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_dtS__T_atS__B_dtS_syms(varargin)
...
syms r_act2 r_inact r_div p_diffAS p_diffB1 r_B_N r_death p_D0 p_Q0 
...
p = [r_act2,r_inact,r_div,p_diffAS,p_diffB1,r_B_N,r_death,p_D0,p_Q0];
...
xdot(23) = C_2_5*r_act2 + 0.55*C_3_4*r_div - C_3_5*r_inact + C_3_5*r_div*(p_diffB1 - 1)^2 + C_3_5*r_div*(p_diffAS - 1)^2 - C_3_5*p_diffB1^2*r_div - C_3_5*p_diffAS^2*r_div;
xdot(24) = C_2_6*r_act2 - C_3_6*r_B_N + 0.45*C_3_4*r_div - C_3_6*r_inact + C_3_6*r_div*(p_diffAS - 1)^2 + 2*C_3_5*p_diffB1^2*r_div - C_3_6*p_diffAS^2*r_div - 2*C_3_5*p_diffB1*r_div*(p_diffB1 - 1);
...
xdot(27) = 0.55*C_4_4*r_div + C_4_5*r_div*(p_diffB1 - 1)^2 - C_4_5*p_diffB1^2*r_div + 2*C_3_5*p_diffAS^2*r_div - 2*C_3_5*p_diffAS*r_div*(p_diffAS - 1);
xdot(28) = 0.45*C_4_4*r_div - C_4_6*r_B_N + 2*C_4_5*p_diffB1^2*r_div + 2*C_3_6*p_diffAS^2*r_div - 2*C_4_5*p_diffB1*r_div*(p_diffB1 - 1) - 2*C_3_6*p_diffAS*r_div*(p_diffAS - 1);
