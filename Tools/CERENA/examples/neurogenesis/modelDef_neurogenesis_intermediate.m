...
[n,str_states,str_rates,optsum,optqSout,optDiv,optTcc,optOutVec,optInitialVals,optAct1_proportional,opt_ract1,opt_pB1,opt_hillcoeffs,opt_halfwayMigration,opt_Ndeath,opt_NB2death,opt_NB3death,opt_dataSet,opt_identicalRates_str] = getSystemDefinition();
...
% Define propensities:
[System.reaction] = getIntermediateReactionsDefinition(stateVariables,n,str_rates,optDiv,optTcc,optAct1_proportional,opt_ract1,opt_pB1,opt_hillcoeffs,opt_halfwayMigration,opt_Ndeath,opt_NB2death,opt_NB3death,opt_dataSet,opt_identicalRates_str);
syms age
System.time = age;
