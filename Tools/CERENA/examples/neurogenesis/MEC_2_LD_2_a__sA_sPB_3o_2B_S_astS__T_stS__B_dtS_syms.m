% function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_astS__T_stS__B_dtS_syms(f0_user)
function [model] = MEC_2_LD_2_a__sA_sPB_3o_2B_S_astS__T_stS__B_dtS_syms(varargin)
...
syms r_act2 r_inact r_div pAS_ASAS pAS_TT pT_TT p_diffB1 r_B_N r_death p_D0 p_Q0 
...
p = [r_act2,r_inact,r_div,pAS_ASAS,pAS_TT,pT_TT,p_diffB1,r_B_N,r_death,p_D0,p_Q0];
...
xdot(4) = 1.0*mu_4*r_div*(pT_TT - 1) - mu_3*r_div*(pAS_TT + pAS_ASAS - 1) + 2*mu_3*pAS_TT*r_div + mu_4*pT_TT*r_div;
...
xdot(11) = 2*C_1_3*pAS_TT*r_div - C_1_3*r_div*(pAS_TT + pAS_ASAS - 1) - C_1_4/5000 + C_1_4*pT_TT*r_div + 1.0*C_1_4*r_div*(pT_TT - 1);
...
xdot(17) = C_1_4/5000 - C_2_4*r_act2 + C_3_4*r_inact - C_2_3*r_div*(pAS_TT + pAS_ASAS - 1) + 2*C_2_3*pAS_TT*r_div + C_2_4*pT_TT*r_div + 1.0*C_2_4*r_div*(pT_TT - 1);
...
xdot(22) = C_2_4*r_act2 - C_3_4*r_inact - C_3_3*r_div*(pAS_TT + pAS_ASAS - 1) + 2*C_3_3*pAS_TT*r_div - C_3_4*pAS_TT*r_div + C_3_4*pAS_ASAS*r_div + C_3_4*pT_TT*r_div - 2*mu_3*pAS_TT*r_div + 1.0*C_3_4*r_div*(pT_TT - 1);
xdot(23) = C_2_5*r_act2 - C_3_5*r_inact + C_3_5*r_div*(p_diffB1 - 1)^2 - C_3_5*pAS_TT*r_div + C_3_5*pAS_ASAS*r_div - 1.1*C_3_4*r_div*(pT_TT - 1) - C_3_5*p_diffB1^2*r_div;
xdot(24) = C_2_6*r_act2 - C_3_6*r_B_N - C_3_6*r_inact - C_3_6*pAS_TT*r_div + C_3_6*pAS_ASAS*r_div - 0.9*C_3_4*r_div*(pT_TT - 1) + 2*C_3_5*p_diffB1^2*r_div - 2*C_3_5*p_diffB1*r_div*(p_diffB1 - 1);
xdot(25) = C_3_6*r_B_N + C_2_7*r_act2 - C_3_7*r_death - C_3_7*r_inact - C_3_7*pAS_TT*r_div + C_3_7*pAS_ASAS*r_div;
xdot(26) = 4*C_3_4*pAS_TT*r_div - 2*C_3_4*r_div*(pAS_TT + pAS_ASAS - 1) - mu_3*r_div*(pAS_TT + pAS_ASAS - 1) - 1.0*mu_4*r_div*(pT_TT - 1) + 2*C_4_4*pT_TT*r_div + 4*mu_3*pAS_TT*r_div + mu_4*pT_TT*r_div + 2.0*C_4_4*r_div*(pT_TT - 1);
xdot(27) = 1.1*mu_4*r_div*(pT_TT - 1) + C_4_5*r_div*(p_diffB1 - 1)^2 - C_3_5*r_div*(pAS_TT + pAS_ASAS - 1) + 2*C_3_5*pAS_TT*r_div + C_4_5*pT_TT*r_div - 1.1*C_4_4*r_div*(pT_TT - 1) + 1.0*C_4_5*r_div*(pT_TT - 1) - C_4_5*p_diffB1^2*r_div;
xdot(28) = 0.9*mu_4*r_div*(pT_TT - 1) - C_4_6*r_B_N - C_3_6*r_div*(pAS_TT + pAS_ASAS - 1) + 2*C_3_6*pAS_TT*r_div + C_4_6*pT_TT*r_div - 0.9*C_4_4*r_div*(pT_TT - 1) + 1.0*C_4_6*r_div*(pT_TT - 1) + 2*C_4_5*p_diffB1^2*r_div - 2*C_4_5*p_diffB1*r_div*(p_diffB1 - 1);
xdot(29) = C_4_6*r_B_N - C_4_7*r_death - C_3_7*r_div*(pAS_TT + pAS_ASAS - 1) + 2*C_3_7*pAS_TT*r_div + C_4_7*pT_TT*r_div + 1.0*C_4_7*r_div*(pT_TT - 1);
