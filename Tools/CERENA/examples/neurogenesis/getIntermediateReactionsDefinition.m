function [reaction] = getIntermediateReactionsDefinition(stateVariables, n_interS, str_rates, optDiv, optTcc,optAct1_proportional,opt_ract1,opt_pB1,opt_hillcoeffs,opt_halfwayMigration)
%author: Lisa Bast
