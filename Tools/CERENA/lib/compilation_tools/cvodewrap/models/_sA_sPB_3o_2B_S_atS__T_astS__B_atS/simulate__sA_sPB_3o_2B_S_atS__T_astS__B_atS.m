% simulate__sA_sPB_3o_2B_S_atS__T_astS__B_atS.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate__sA_sPB_3o_2B_S_atS__T_astS__B_atS(tout,theta)
% [...] = simulate__sA_sPB_3o_2B_S_atS__T_astS__B_atS(tout,theta,kappa,options)
% sol = simulate__sA_sPB_3o_2B_S_atS__T_astS__B_atS(...)
% [status,tout,x,y,sx,sy] = simulate__sA_sPB_3o_2B_S_atS__T_astS__B_atS(...)
%
% INPUTS:
% =======
...
function varargout = simulate__sA_sPB_3o_2B_S_atS__T_astS__B_atS(varargin)
...
options_cvode.nnz = 118; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 33;

options_cvode.lbw = 23;
...
if(max(options_cvode.sens_ind)>9)
    error('Sensitivity index exceeds parameter dimension!')
end
rt = [18  21  29  30   4   5   2  16  17  19  25  12  15  13  20  23  24  27  26  14  22  31  11  28  32  33  34  35  10   1   9   6   8   7   3];
cw__sA_sPB_3o_2B_S_atS__T_astS__B_atS(sol,tout,theta(1:9),kappa(1:70),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);
