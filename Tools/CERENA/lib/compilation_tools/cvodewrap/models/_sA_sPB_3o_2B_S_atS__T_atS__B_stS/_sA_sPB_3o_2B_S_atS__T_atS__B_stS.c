#include "_sA_sPB_3o_2B_S_atS__T_atS__B_stS.h"
...
#define pi 3.141592653589793
 ...
 int xdot__sA_sPB_3o_2B_S_atS__T_atS__B_stS(realtype t, N_Vector x, N_Vector xdot, void *user_data)
{
  int ix;
...
xdot_tmp[0] = 0.55*p[2]*x_tmp[29] - 0.0002*x_tmp[0] + (p[3] - 1.0)*p[2]*x_tmp[0] + p[2]*p[3]*x_tmp[0];
...
xdot_tmp[3] = 0.45*p[2]*x_tmp[29] - 1.0*p[4]*x_tmp[3] - 0.0002*x_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*x_tmp[0];
...
xdot_tmp[15] = 0.55*p[2]*x_tmp[22] - 1.0*p[5]*x_tmp[15] + p[4]*x_tmp[20] + (p[3] - 1.0)*p[2]*x_tmp[15] + p[2]*p[3]*x_tmp[15];
xdot_tmp[16] = 0.45*p[2]*x_tmp[22] - 1.0*p[5]*x_tmp[16] - 1.0*p[4]*x_tmp[19] - 1.0*p[4]*x_tmp[16] + p[4]*x_tmp[21] - 2.0*(p[3] - 1.0)*p[2]*x_tmp[15];
xdot_tmp[17] = 0.55*p[2]*x_tmp[23] + 1.1*p[2]*x_tmp[26] + 2.0*(p[3] - 1.0)*p[2]*x_tmp[17] - 1.0*(p[3] - 1.0)*p[2]*x_tmp[18] + 2.0*p[2]*p[3]*x_tmp[17] + p[2]*p[3]*x_tmp[18];
xdot_tmp[18] = 0.55*p[2]*x_tmp[23] + (p[3] - 1.0)*p[2]*x_tmp[18] + p[2]*p[3]*x_tmp[18];
xdot_tmp[19] = 0.45*p[2]*x_tmp[23] - 1.0*p[4]*x_tmp[19] - 2.0*(p[3] - 1.0)*p[2]*x_tmp[18];
xdot_tmp[20] = 0.55*p[2]*x_tmp[25] - 1.0*p[4]*x_tmp[20] + 0.45*p[2]*x_tmp[26] - 2.0*(p[3] - 1.0)*p[2]*x_tmp[17] + 2.0*(p[3] - 1.0)*p[2]*x_tmp[18] + (p[3] - 1.0)*p[2]*x_tmp[20] + p[2]*p[3]*x_tmp[20];
xdot_tmp[21] = p[4]*x_tmp[19] + 0.45*p[2]*x_tmp[23] - 2.0*p[4]*x_tmp[21] + 0.9*p[2]*x_tmp[25] - 4.0*(p[3] - 1.0)*p[2]*x_tmp[18] - 4.0*(p[3] - 1.0)*p[2]*x_tmp[20];
xdot_tmp[22] = p[4]*x_tmp[25] - 1.0*p[5]*x_tmp[22] + p[2]*x_tmp[33];
xdot_tmp[23] = p[2]*x_tmp[28];
xdot_tmp[24] = p[2]*x_tmp[28] + 2.0*p[2]*x_tmp[32];
xdot_tmp[25] = 0.45*p[2]*x_tmp[24] + p[2]*x_tmp[27] - 1.0*p[4]*x_tmp[25] - 2.0*(p[3] - 1.0)*p[2]*x_tmp[26];
xdot_tmp[26] = p[2]*x_tmp[12] + 0.55*p[2]*x_tmp[24] + (p[3] - 1.0)*p[2]*x_tmp[26] + p[2]*p[3]*x_tmp[26];
xdot_tmp[27] = p[0]*x_tmp[34] - 1.0*p[4]*x_tmp[27] - 1.0*p[1]*x_tmp[27] + 0.45*p[2]*x_tmp[32] - 2.0*(p[3] - 1.0)*p[2]*x_tmp[12];
...
xdot_tmp[31] = p[1]*x_tmp[12] - 1.0*p[0]*x_tmp[31] + 0.55*p[2]*x_tmp[30] + 0.0002*x_tmp[0] + (p[3] - 1.0)*p[2]*x_tmp[31] + p[2]*p[3]*x_tmp[31];
...
xdot_tmp[34] = p[1]*x_tmp[27] + 0.45*p[2]*x_tmp[30] - 1.0*p[0]*x_tmp[34] - 1.0*p[4]*x_tmp[34] + 0.0002*x_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*x_tmp[31];
 ...
 int xBdot__sA_sPB_3o_2B_S_atS__T_atS__B_stS(realtype t, N_Vector x, N_Vector xB, N_Vector xBdot, void *user_data)
{
  int ixB;
  UserData data = (UserData) user_data;
  double *p = data->p;
...
xBdot_tmp[0] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[3] - 0.0002*xB_tmp[31] - 1.0*xB_tmp[0]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[12] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[27] - 1.0*p[1]*xB_tmp[31] - 1.0*xB_tmp[12]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[26];
xBdot_tmp[13] = p[5]*xB_tmp[13] - 1.0*p[5]*xB_tmp[14];
xBdot_tmp[14] = 2.0*p[5]*xB_tmp[14];
xBdot_tmp[15] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[16] - 1.0*xB_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[16] = xB_tmp[16]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[14];
xBdot_tmp[17] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[20] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[17];
xBdot_tmp[18] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[17] - 1.0*xB_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[19] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[20] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[21];
xBdot_tmp[19] = p[4]*xB_tmp[16] - 1.0*p[4]*xB_tmp[14] - 1.0*p[4]*xB_tmp[13] + p[4]*xB_tmp[19] - 1.0*p[4]*xB_tmp[21];
xBdot_tmp[20] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[21] - 1.0*xB_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[15];
...
xBdot_tmp[26] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[25] - 0.45*p[2]*xB_tmp[20] - 1.0*xB_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[17];
...
xBdot_tmp[31] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[34] - 1.0*xB_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[12];
...
xBdot_tmp[35] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[38] - 0.0002*xB_tmp[66] - 1.0*xB_tmp[35]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[47] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[62] - 1.0*p[1]*xB_tmp[66] - 1.0*xB_tmp[47]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[61];
xBdot_tmp[48] = p[5]*xB_tmp[48] - 1.0*p[5]*xB_tmp[49];
xBdot_tmp[49] = 2.0*p[5]*xB_tmp[49];
xBdot_tmp[50] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[51] - 1.0*xB_tmp[50]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[51] = xB_tmp[51]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[49];
xBdot_tmp[52] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[55] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[52];
xBdot_tmp[53] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[52] - 1.0*xB_tmp[53]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[54] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[55] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[56];
xBdot_tmp[54] = p[4]*xB_tmp[51] - 1.0*p[4]*xB_tmp[49] - 1.0*p[4]*xB_tmp[48] + p[4]*xB_tmp[54] - 1.0*p[4]*xB_tmp[56];
xBdot_tmp[55] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[56] - 1.0*xB_tmp[55]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[50];
...
xBdot_tmp[61] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[60] - 0.45*p[2]*xB_tmp[55] - 1.0*xB_tmp[61]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[52];
...
xBdot_tmp[66] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[69] - 1.0*xB_tmp[66]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[47];
...
xBdot_tmp[70] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[73] - 0.0002*xB_tmp[101] - 1.0*xB_tmp[70]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[82] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[97] - 1.0*p[1]*xB_tmp[101] - 1.0*xB_tmp[82]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[96];
xBdot_tmp[83] = p[5]*xB_tmp[83] - 1.0*p[5]*xB_tmp[84];
xBdot_tmp[84] = 2.0*p[5]*xB_tmp[84];
xBdot_tmp[85] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[86] - 1.0*xB_tmp[85]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[86] = xB_tmp[86]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[84];
xBdot_tmp[87] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[90] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[87];
xBdot_tmp[88] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[87] - 1.0*xB_tmp[88]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[89] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[90] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[91];
xBdot_tmp[89] = p[4]*xB_tmp[86] - 1.0*p[4]*xB_tmp[84] - 1.0*p[4]*xB_tmp[83] + p[4]*xB_tmp[89] - 1.0*p[4]*xB_tmp[91];
xBdot_tmp[90] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[91] - 1.0*xB_tmp[90]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[85];
...
xBdot_tmp[96] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[95] - 0.45*p[2]*xB_tmp[90] - 1.0*xB_tmp[96]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[87];
...
xBdot_tmp[101] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[104] - 1.0*xB_tmp[101]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[82];
...
xBdot_tmp[105] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[108] - 0.0002*xB_tmp[136] - 1.0*xB_tmp[105]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[117] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[132] - 1.0*p[1]*xB_tmp[136] - 1.0*xB_tmp[117]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[131];
xBdot_tmp[118] = p[5]*xB_tmp[118] - 1.0*p[5]*xB_tmp[119];
xBdot_tmp[119] = 2.0*p[5]*xB_tmp[119];
xBdot_tmp[120] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[121] - 1.0*xB_tmp[120]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[121] = xB_tmp[121]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[119];
xBdot_tmp[122] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[125] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[122];
xBdot_tmp[123] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[122] - 1.0*xB_tmp[123]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[124] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[125] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[126];
xBdot_tmp[124] = p[4]*xB_tmp[121] - 1.0*p[4]*xB_tmp[119] - 1.0*p[4]*xB_tmp[118] + p[4]*xB_tmp[124] - 1.0*p[4]*xB_tmp[126];
xBdot_tmp[125] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[126] - 1.0*xB_tmp[125]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[120];
...
xBdot_tmp[131] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[130] - 0.45*p[2]*xB_tmp[125] - 1.0*xB_tmp[131]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[122];
...
xBdot_tmp[136] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[139] - 1.0*xB_tmp[136]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[117];
...
xBdot_tmp[140] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[143] - 0.0002*xB_tmp[171] - 1.0*xB_tmp[140]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[152] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[167] - 1.0*p[1]*xB_tmp[171] - 1.0*xB_tmp[152]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[166];
xBdot_tmp[153] = p[5]*xB_tmp[153] - 1.0*p[5]*xB_tmp[154];
xBdot_tmp[154] = 2.0*p[5]*xB_tmp[154];
xBdot_tmp[155] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[156] - 1.0*xB_tmp[155]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[156] = xB_tmp[156]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[154];
xBdot_tmp[157] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[160] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[157];
xBdot_tmp[158] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[157] - 1.0*xB_tmp[158]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[159] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[160] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[161];
xBdot_tmp[159] = p[4]*xB_tmp[156] - 1.0*p[4]*xB_tmp[154] - 1.0*p[4]*xB_tmp[153] + p[4]*xB_tmp[159] - 1.0*p[4]*xB_tmp[161];
xBdot_tmp[160] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[161] - 1.0*xB_tmp[160]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[155];
...
xBdot_tmp[166] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[165] - 0.45*p[2]*xB_tmp[160] - 1.0*xB_tmp[166]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[157];
...
xBdot_tmp[171] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[174] - 1.0*xB_tmp[171]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[152];
...
xBdot_tmp[175] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[178] - 0.0002*xB_tmp[206] - 1.0*xB_tmp[175]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[187] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[202] - 1.0*p[1]*xB_tmp[206] - 1.0*xB_tmp[187]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[201];
xBdot_tmp[188] = p[5]*xB_tmp[188] - 1.0*p[5]*xB_tmp[189];
xBdot_tmp[189] = 2.0*p[5]*xB_tmp[189];
xBdot_tmp[190] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[191] - 1.0*xB_tmp[190]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[191] = xB_tmp[191]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[189];
xBdot_tmp[192] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[195] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[192];
xBdot_tmp[193] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[192] - 1.0*xB_tmp[193]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[194] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[195] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[196];
xBdot_tmp[194] = p[4]*xB_tmp[191] - 1.0*p[4]*xB_tmp[189] - 1.0*p[4]*xB_tmp[188] + p[4]*xB_tmp[194] - 1.0*p[4]*xB_tmp[196];
xBdot_tmp[195] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[196] - 1.0*xB_tmp[195]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[190];
...
xBdot_tmp[201] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[200] - 0.45*p[2]*xB_tmp[195] - 1.0*xB_tmp[201]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[192];
...
xBdot_tmp[206] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[209] - 1.0*xB_tmp[206]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[187];
...
xBdot_tmp[210] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[213] - 0.0002*xB_tmp[241] - 1.0*xB_tmp[210]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[222] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[237] - 1.0*p[1]*xB_tmp[241] - 1.0*xB_tmp[222]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[236];
xBdot_tmp[223] = p[5]*xB_tmp[223] - 1.0*p[5]*xB_tmp[224];
xBdot_tmp[224] = 2.0*p[5]*xB_tmp[224];
xBdot_tmp[225] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[226] - 1.0*xB_tmp[225]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[226] = xB_tmp[226]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[224];
xBdot_tmp[227] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[230] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[227];
xBdot_tmp[228] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[227] - 1.0*xB_tmp[228]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[229] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[230] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[231];
xBdot_tmp[229] = p[4]*xB_tmp[226] - 1.0*p[4]*xB_tmp[224] - 1.0*p[4]*xB_tmp[223] + p[4]*xB_tmp[229] - 1.0*p[4]*xB_tmp[231];
xBdot_tmp[230] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[231] - 1.0*xB_tmp[230]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[225];
...
xBdot_tmp[236] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[235] - 0.45*p[2]*xB_tmp[230] - 1.0*xB_tmp[236]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[227];
...
xBdot_tmp[241] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[244] - 1.0*xB_tmp[241]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[222];
...
xBdot_tmp[245] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[248] - 0.0002*xB_tmp[276] - 1.0*xB_tmp[245]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[257] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[272] - 1.0*p[1]*xB_tmp[276] - 1.0*xB_tmp[257]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[271];
xBdot_tmp[258] = p[5]*xB_tmp[258] - 1.0*p[5]*xB_tmp[259];
xBdot_tmp[259] = 2.0*p[5]*xB_tmp[259];
xBdot_tmp[260] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[261] - 1.0*xB_tmp[260]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[261] = xB_tmp[261]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[259];
xBdot_tmp[262] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[265] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[262];
xBdot_tmp[263] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[262] - 1.0*xB_tmp[263]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[264] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[265] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[266];
xBdot_tmp[264] = p[4]*xB_tmp[261] - 1.0*p[4]*xB_tmp[259] - 1.0*p[4]*xB_tmp[258] + p[4]*xB_tmp[264] - 1.0*p[4]*xB_tmp[266];
xBdot_tmp[265] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[266] - 1.0*xB_tmp[265]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[260];
...
xBdot_tmp[271] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[270] - 0.45*p[2]*xB_tmp[265] - 1.0*xB_tmp[271]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[262];
...
xBdot_tmp[276] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[279] - 1.0*xB_tmp[276]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[257];
...
xBdot_tmp[280] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[283] - 0.0002*xB_tmp[311] - 1.0*xB_tmp[280]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
xBdot_tmp[292] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[307] - 1.0*p[1]*xB_tmp[311] - 1.0*xB_tmp[292]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*xB_tmp[306];
xBdot_tmp[293] = p[5]*xB_tmp[293] - 1.0*p[5]*xB_tmp[294];
xBdot_tmp[294] = 2.0*p[5]*xB_tmp[294];
xBdot_tmp[295] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[296] - 1.0*xB_tmp[295]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
xBdot_tmp[296] = xB_tmp[296]*(p[4] + p[5]) - 2.0*p[4]*xB_tmp[294];
xBdot_tmp[297] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[300] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*xB_tmp[297];
xBdot_tmp[298] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*xB_tmp[297] - 1.0*xB_tmp[298]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*xB_tmp[299] - 2.0*(p[3] - 1.0)*p[2]*xB_tmp[300] + 4.0*(p[3] - 1.0)*p[2]*xB_tmp[301];
xBdot_tmp[299] = p[4]*xB_tmp[296] - 1.0*p[4]*xB_tmp[294] - 1.0*p[4]*xB_tmp[293] + p[4]*xB_tmp[299] - 1.0*p[4]*xB_tmp[301];
xBdot_tmp[300] = 4.0*(p[3] - 1.0)*p[2]*xB_tmp[301] - 1.0*xB_tmp[300]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*xB_tmp[295];
...
xBdot_tmp[306] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[305] - 0.45*p[2]*xB_tmp[300] - 1.0*xB_tmp[306]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*xB_tmp[297];
...
xBdot_tmp[311] = 2.0*(p[3] - 1.0)*p[2]*xB_tmp[314] - 1.0*xB_tmp[311]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*xB_tmp[292];
...
xBdot_tmp[314] = xB_tmp[314]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[307] - 1.0*p[4]*xB_tmp[282];
 ...
 int xQB__sA_sPB_3o_2B_S_atS__T_atS__B_stS(realtype t, N_Vector x, N_Vector xB, N_Vector qBdot, void *user_data)
{
  int iyp;
  int ip;
  UserData data = (UserData) user_data;
...
qBdot_tmp[8+ip*ny] = x_tmp[7]*xB_tmp[287] - 1.0*x_tmp[7]*xB_tmp[285] + x_tmp[12]*xB_tmp[292] - 1.0*x_tmp[33]*xB_tmp[282] - 1.0*x_tmp[28]*xB_tmp[289] - 1.0*x_tmp[12]*xB_tmp[311] + x_tmp[27]*xB_tmp[307] + x_tmp[28]*xB_tmp[308] - 1.0*x_tmp[27]*xB_tmp[314] - 1.0*x_tmp[32]*xB_tmp[310] + x_tmp[32]*xB_tmp[312] + x_tmp[33]*xB_tmp[313] + (2.0*x_tmp[10] - 1.0*x_tmp[28])*xB_tmp[290] + xB_tmp[291]*(x_tmp[11] - 1.0*x_tmp[10] + x_tmp[28]) - 1.0*(2.0*x_tmp[11] + x_tmp[28])*xB_tmp[288];
  ...
  case 2: {
qBdot_tmp[0+ip*ny] = xB_tmp[3]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[30] - 1.0*x_tmp[10]*xB_tmp[32] - 1.0*x_tmp[28]*xB_tmp[23] - 1.0*x_tmp[33]*xB_tmp[22] - 1.0*x_tmp[7]*xB_tmp[29] + xB_tmp[16]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[19]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[27]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[34]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[20]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[26]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[17]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[21]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[0]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[15]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[12]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[18]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[31]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[24] - 1.0*xB_tmp[25]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[1+ip*ny] = xB_tmp[38]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[65] - 1.0*x_tmp[10]*xB_tmp[67] - 1.0*x_tmp[28]*xB_tmp[58] - 1.0*x_tmp[33]*xB_tmp[57] - 1.0*x_tmp[7]*xB_tmp[64] + xB_tmp[51]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[54]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[62]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[69]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[55]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[61]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[52]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[56]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[35]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[50]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[47]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[53]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[66]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[59] - 1.0*xB_tmp[60]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[2+ip*ny] = xB_tmp[73]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[100] - 1.0*x_tmp[10]*xB_tmp[102] - 1.0*x_tmp[28]*xB_tmp[93] - 1.0*x_tmp[33]*xB_tmp[92] - 1.0*x_tmp[7]*xB_tmp[99] + xB_tmp[86]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[89]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[97]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[104]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[90]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[96]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[87]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[91]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[70]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[85]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[82]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[88]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[101]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[94] - 1.0*xB_tmp[95]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[3+ip*ny] = xB_tmp[108]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[135] - 1.0*x_tmp[10]*xB_tmp[137] - 1.0*x_tmp[28]*xB_tmp[128] - 1.0*x_tmp[33]*xB_tmp[127] - 1.0*x_tmp[7]*xB_tmp[134] + xB_tmp[121]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[124]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[132]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[139]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[125]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[131]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[122]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[126]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[105]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[120]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[117]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[123]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[136]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[129] - 1.0*xB_tmp[130]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[4+ip*ny] = xB_tmp[143]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[170] - 1.0*x_tmp[10]*xB_tmp[172] - 1.0*x_tmp[28]*xB_tmp[163] - 1.0*x_tmp[33]*xB_tmp[162] - 1.0*x_tmp[7]*xB_tmp[169] + xB_tmp[156]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[159]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[167]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[174]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[160]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[166]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[157]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[161]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[140]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[155]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[152]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[158]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[171]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[164] - 1.0*xB_tmp[165]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[5+ip*ny] = xB_tmp[178]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[205] - 1.0*x_tmp[10]*xB_tmp[207] - 1.0*x_tmp[28]*xB_tmp[198] - 1.0*x_tmp[33]*xB_tmp[197] - 1.0*x_tmp[7]*xB_tmp[204] + xB_tmp[191]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[194]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[202]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[209]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[195]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[201]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[192]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[196]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[175]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[190]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[187]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[193]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[206]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[199] - 1.0*xB_tmp[200]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[6+ip*ny] = xB_tmp[213]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[240] - 1.0*x_tmp[10]*xB_tmp[242] - 1.0*x_tmp[28]*xB_tmp[233] - 1.0*x_tmp[33]*xB_tmp[232] - 1.0*x_tmp[7]*xB_tmp[239] + xB_tmp[226]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[229]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[237]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[244]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[230]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[236]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[227]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[231]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[210]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[225]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[222]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[228]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[241]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[234] - 1.0*xB_tmp[235]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[7+ip*ny] = xB_tmp[248]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[275] - 1.0*x_tmp[10]*xB_tmp[277] - 1.0*x_tmp[28]*xB_tmp[268] - 1.0*x_tmp[33]*xB_tmp[267] - 1.0*x_tmp[7]*xB_tmp[274] + xB_tmp[261]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[264]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[272]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[279]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[265]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[271]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[262]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[266]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[245]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[260]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[257]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[263]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[276]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[269] - 1.0*xB_tmp[270]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
qBdot_tmp[8+ip*ny] = xB_tmp[283]*(2.0*(p[3] - 1.0)*x_tmp[0] - 0.45*x_tmp[29]) - 1.0*x_tmp[11]*xB_tmp[310] - 1.0*x_tmp[10]*xB_tmp[312] - 1.0*x_tmp[28]*xB_tmp[303] - 1.0*x_tmp[33]*xB_tmp[302] - 1.0*x_tmp[7]*xB_tmp[309] + xB_tmp[296]*(2.0*(p[3] - 1.0)*x_tmp[15] - 0.45*x_tmp[22]) + xB_tmp[299]*(2.0*(p[3] - 1.0)*x_tmp[18] - 0.45*x_tmp[23]) + xB_tmp[307]*(2.0*(p[3] - 1.0)*x_tmp[12] - 0.45*x_tmp[32]) + xB_tmp[314]*(2.0*(p[3] - 1.0)*x_tmp[31] - 0.45*x_tmp[30]) - 1.0*xB_tmp[300]*(p[3]*x_tmp[20] - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*xB_tmp[306]*(p[3]*x_tmp[26] + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24]) - 1.0*xB_tmp[297]*(2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23] + 1.1*x_tmp[26]) + xB_tmp[301]*(4.0*(p[3] - 1.0)*x_tmp[18] + 4.0*(p[3] - 1.0)*x_tmp[20] - 0.45*x_tmp[23] - 0.9*x_tmp[25]) - 1.0*xB_tmp[280]*(p[3]*x_tmp[0] + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29]) - 1.0*xB_tmp[295]*(p[3]*x_tmp[15] + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22]) - 1.0*xB_tmp[292]*(p[3]*x_tmp[12] + (p[3] - 1.0)*x_tmp[12] + 0.55*x_tmp[32]) - 1.0*xB_tmp[298]*(p[3]*x_tmp[18] + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23]) - 1.0*xB_tmp[311]*(p[3]*x_tmp[31] + (p[3] - 1.0)*x_tmp[31] + 0.55*x_tmp[30]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[304] - 1.0*xB_tmp[305]*(0.45*x_tmp[24] - 2.0*(p[3] - 1.0)*x_tmp[26] + x_tmp[27]);
...
qBdot_tmp[8+ip*ny] = x_tmp[1]*xB_tmp[281] + x_tmp[2]*xB_tmp[282] + x_tmp[13]*xB_tmp[293] + x_tmp[15]*xB_tmp[295] + x_tmp[16]*xB_tmp[296] + x_tmp[22]*xB_tmp[302] + x_tmp[33]*xB_tmp[313] - 1.0*(x_tmp[13] - 2.0*x_tmp[14])*xB_tmp[294];
 ...
 void x0__sA_sPB_3o_2B_S_atS__T_atS__B_stS(N_Vector x0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
...
x0_tmp[34] = k[18]*k[53];
 ...
 int Jv__sA_sPB_3o_2B_S_atS__T_atS__B_stS(N_Vector v, N_Vector Jv, realtype t,
...
Jv_tmp[0] = 0.55*p[2]*v_tmp[29] + v_tmp[0]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
Jv_tmp[1] = p[4]*v_tmp[3] - 1.0*(p[5] + 0.0002)*v_tmp[1];
Jv_tmp[2] = p[1]*v_tmp[33] + p[4]*v_tmp[34] - 1.0*v_tmp[2]*(p[0] + p[5]) + 0.0002*v_tmp[1];
Jv_tmp[3] = 0.45*p[2]*v_tmp[29] - 1.0*(p[4] + 0.0002)*v_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*v_tmp[0];
...
Jv_tmp[15] = 0.55*p[2]*v_tmp[22] + p[4]*v_tmp[20] + v_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
Jv_tmp[16] = 0.45*p[2]*v_tmp[22] - 1.0*p[4]*v_tmp[19] + p[4]*v_tmp[21] - 1.0*v_tmp[16]*(p[4] + p[5]) - 2.0*(p[3] - 1.0)*p[2]*v_tmp[15];
Jv_tmp[17] = 0.55*p[2]*v_tmp[23] + 1.1*p[2]*v_tmp[26] - 1.0*((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*v_tmp[18] + (2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*v_tmp[17];
Jv_tmp[18] = 0.55*p[2]*v_tmp[23] + v_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
Jv_tmp[19] = 0.45*p[2]*v_tmp[23] - 1.0*p[4]*v_tmp[19] - 2.0*(p[3] - 1.0)*p[2]*v_tmp[18];
Jv_tmp[20] = 0.55*p[2]*v_tmp[25] + 0.45*p[2]*v_tmp[26] + v_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 2.0*(p[3] - 1.0)*p[2]*v_tmp[17] + 2.0*(p[3] - 1.0)*p[2]*v_tmp[18];
Jv_tmp[21] = p[4]*v_tmp[19] + 0.45*p[2]*v_tmp[23] - 2.0*p[4]*v_tmp[21] + 0.9*p[2]*v_tmp[25] - 4.0*(p[3] - 1.0)*p[2]*v_tmp[18] - 4.0*(p[3] - 1.0)*p[2]*v_tmp[20];
Jv_tmp[22] = p[4]*v_tmp[25] - 1.0*p[5]*v_tmp[22] + p[2]*v_tmp[33];
Jv_tmp[23] = p[2]*v_tmp[28];
Jv_tmp[24] = p[2]*v_tmp[28] + 2.0*p[2]*v_tmp[32];
Jv_tmp[25] = 0.45*p[2]*v_tmp[24] + p[2]*v_tmp[27] - 1.0*p[4]*v_tmp[25] - 2.0*(p[3] - 1.0)*p[2]*v_tmp[26];
Jv_tmp[26] = p[2]*v_tmp[12] + 0.55*p[2]*v_tmp[24] + v_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
Jv_tmp[27] = p[0]*v_tmp[34] + 0.45*p[2]*v_tmp[32] - 1.0*v_tmp[27]*(p[1] + p[4]) - 2.0*(p[3] - 1.0)*p[2]*v_tmp[12];
...
Jv_tmp[31] = p[1]*v_tmp[12] + 0.55*p[2]*v_tmp[30] + v_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) + 0.0002*v_tmp[0];
Jv_tmp[32] = p[2]*v_tmp[10] + p[0]*v_tmp[30] - 1.0*p[1]*v_tmp[32];
Jv_tmp[33] = p[0]*v_tmp[2] + p[4]*v_tmp[27] - 1.0*v_tmp[33]*(p[1] + p[5]);
Jv_tmp[34] = p[1]*v_tmp[27] + 0.45*p[2]*v_tmp[30] - 1.0*v_tmp[34]*(p[0] + p[4]) + 0.0002*v_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*v_tmp[31];
 ...
 int JvB__sA_sPB_3o_2B_S_atS__T_atS__B_stS(N_Vector vB, N_Vector JvB, realtype t,
...
JvB_tmp[0] = 2.0*(p[3] - 1.0)*p[2]*vB_tmp[3] - 0.0002*vB_tmp[31] - 1.0*vB_tmp[0]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
JvB_tmp[12] = 2.0*(p[3] - 1.0)*p[2]*vB_tmp[27] - 1.0*p[1]*vB_tmp[31] - 1.0*vB_tmp[12]*((p[3] - 1.0)*p[2] - 1.0*p[1] + p[2]*p[3]) - 1.0*p[2]*vB_tmp[26];
JvB_tmp[13] = p[5]*vB_tmp[13] - 1.0*p[5]*vB_tmp[14];
JvB_tmp[14] = 2.0*p[5]*vB_tmp[14];
JvB_tmp[15] = 2.0*(p[3] - 1.0)*p[2]*vB_tmp[16] - 1.0*vB_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
JvB_tmp[16] = vB_tmp[16]*(p[4] + p[5]) - 2.0*p[4]*vB_tmp[14];
JvB_tmp[17] = 2.0*(p[3] - 1.0)*p[2]*vB_tmp[20] - 1.0*(2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*vB_tmp[17];
JvB_tmp[18] = ((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*vB_tmp[17] - 1.0*vB_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + 2.0*(p[3] - 1.0)*p[2]*vB_tmp[19] - 2.0*(p[3] - 1.0)*p[2]*vB_tmp[20] + 4.0*(p[3] - 1.0)*p[2]*vB_tmp[21];
JvB_tmp[19] = p[4]*vB_tmp[16] - 1.0*p[4]*vB_tmp[14] - 1.0*p[4]*vB_tmp[13] + p[4]*vB_tmp[19] - 1.0*p[4]*vB_tmp[21];
JvB_tmp[20] = 4.0*(p[3] - 1.0)*p[2]*vB_tmp[21] - 1.0*vB_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*p[4]*vB_tmp[15];
...
JvB_tmp[26] = 2.0*(p[3] - 1.0)*p[2]*vB_tmp[25] - 0.45*p[2]*vB_tmp[20] - 1.0*vB_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]) - 1.1*p[2]*vB_tmp[17];
...
JvB_tmp[31] = 2.0*(p[3] - 1.0)*p[2]*vB_tmp[34] - 1.0*vB_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) - 1.0*p[0]*vB_tmp[12];
...
JvB_tmp[34] = vB_tmp[34]*(p[0] + p[4]) - 1.0*p[0]*vB_tmp[27] - 1.0*p[4]*vB_tmp[2];
 ...
 int JBand__sA_sPB_3o_2B_S_atS__T_atS__B_stS(long int N, long int mupper, long int mlower,   realtype t, N_Vector x, N_Vector xdot,
  	DlsMat J, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  return(J__sA_sPB_3o_2B_S_atS__T_atS__B_stS(N,t,x,xdot,J,user_data,tmp1,tmp2,tmp3));
}


 int J__sA_sPB_3o_2B_S_atS__T_atS__B_stS(long int N, realtype t, N_Vector x,
...
J->data[0] = (p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002;
J->data[3] = -2.0*(p[3] - 1.0)*p[2];
J->data[31] = 0.0002;
...
J->data[446] = p[2];
J->data[447] = -2.0*(p[3] - 1.0)*p[2];
J->data[451] = p[1];
J->data[468] = -1.0*p[5];
J->data[469] = p[5];
J->data[504] = -2.0*p[5];
J->data[540] = (p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3];
J->data[541] = -2.0*(p[3] - 1.0)*p[2];
J->data[574] = 2.0*p[4];
J->data[576] = - 1.0*p[4] - 1.0*p[5];
J->data[612] = 2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3];
J->data[615] = -2.0*(p[3] - 1.0)*p[2];
J->data[647] = p[2]*p[3] - 1.0*(p[3] - 1.0)*p[2];
J->data[648] = (p[3] - 1.0)*p[2] + p[2]*p[3];
J->data[649] = -2.0*(p[3] - 1.0)*p[2];
J->data[650] = 2.0*(p[3] - 1.0)*p[2];
J->data[651] = -4.0*(p[3] - 1.0)*p[2];
J->data[678] = p[4];
J->data[679] = p[4];
J->data[681] = -1.0*p[4];
J->data[684] = -1.0*p[4];
J->data[686] = p[4];
J->data[715] = p[4];
J->data[720] = (p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3];
J->data[721] = -4.0*(p[3] - 1.0)*p[2];
J->data[751] = p[4];
J->data[756] = -2.0*p[4];
J->data[785] = 0.55*p[2];
J->data[786] = 0.45*p[2];
...
J->data[927] = 1.1*p[2];
J->data[930] = 0.45*p[2];
J->data[935] = -2.0*(p[3] - 1.0)*p[2];
J->data[936] = (p[3] - 1.0)*p[2] + p[2]*p[3];
J->data[970] = p[2];
...
J->data[1097] = p[0];
J->data[1116] = (p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3];
J->data[1119] = -2.0*(p[3] - 1.0)*p[2];
...
J->data[1224] = - 1.0*p[0] - 1.0*p[4];
 ...
 int JSparse__sA_sPB_3o_2B_S_atS__T_atS__B_stS(realtype t, N_Vector x,
...
J->data[39] = p[2];
J->data[40] = -2.0*(p[3] - 1.0)*p[2];
J->data[41] = p[1];
J->data[42] = -1.0*p[5];
J->data[43] = p[5];
J->data[44] = -2.0*p[5];
J->data[45] = (p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3];
J->data[46] = -2.0*(p[3] - 1.0)*p[2];
J->data[47] = 2.0*p[4];
J->data[48] = - 1.0*p[4] - 1.0*p[5];
J->data[49] = 2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3];
J->data[50] = -2.0*(p[3] - 1.0)*p[2];
J->data[51] = p[2]*p[3] - 1.0*(p[3] - 1.0)*p[2];
J->data[52] = (p[3] - 1.0)*p[2] + p[2]*p[3];
J->data[53] = -2.0*(p[3] - 1.0)*p[2];
J->data[54] = 2.0*(p[3] - 1.0)*p[2];
J->data[55] = -4.0*(p[3] - 1.0)*p[2];
J->data[56] = p[4];
J->data[57] = p[4];
J->data[58] = -1.0*p[4];
J->data[59] = -1.0*p[4];
J->data[60] = p[4];
J->data[61] = p[4];
J->data[62] = (p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3];
J->data[63] = -4.0*(p[3] - 1.0)*p[2];
J->data[64] = p[4];
J->data[65] = -2.0*p[4];
J->data[66] = 0.55*p[2];
J->data[67] = 0.45*p[2];
...
J->data[79] = 1.1*p[2];
J->data[80] = 0.45*p[2];
J->data[81] = -2.0*(p[3] - 1.0)*p[2];
J->data[82] = (p[3] - 1.0)*p[2] + p[2]*p[3];
J->data[83] = p[2];
...
J->data[101] = 0.45*p[2];
J->data[102] = p[0];
J->data[103] = (p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3];
J->data[104] = -2.0*(p[3] - 1.0)*p[2];
J->data[105] = 0.55*p[2];
J->data[106] = 2.0*p[2];
J->data[107] = 0.45*p[2];
J->data[108] = p[1];
...
J->data[115] = - 1.0*p[0] - 1.0*p[4];
 ...
 int JBBand__sA_sPB_3o_2B_S_atS__T_atS__B_stS(long int NeqB, long int mupper, long int mlower,   realtype t, N_Vector x, N_Vector xB,
  	N_Vector xdotB, DlsMat J, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  return(JB__sA_sPB_3o_2B_S_atS__T_atS__B_stS(NeqB,t,x,xB,xdotB,J,user_data,tmp1,tmp2,tmp3));
}
 int JB__sA_sPB_3o_2B_S_atS__T_atS__B_stS(long int N, realtype t, N_Vector x,
  	...
  	N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B)
{
  ...
  double *x_tmp = N_VGetArrayPointer(x);
  double *xB_tmp = N_VGetArrayPointer(xB);
JB->data[0] = 0.0002 - 1.0*p[2]*p[3] - 1.0*(p[3] - 1.0)*p[2];
JB->data[29] = -0.55*p[2];
...
JB->data[506] = -2.0*p[4];
JB->data[509] = -1.0*p[4];
JB->data[540] = p[5] - 1.0*(p[3] - 1.0)*p[2] - 1.0*p[2]*p[3];
JB->data[545] = -1.0*p[4];
JB->data[547] = -0.55*p[2];
JB->data[575] = 2.0*(p[3] - 1.0)*p[2];
JB->data[576] = p[4] + p[5];
JB->data[579] = p[4];
JB->data[581] = -1.0*p[4];
JB->data[582] = -0.45*p[2];
JB->data[612] = - 2.0*(p[3] - 1.0)*p[2] - 2.0*p[2]*p[3];
JB->data[613] = (p[3] - 1.0)*p[2] - 1.0*p[2]*p[3];
JB->data[618] = -0.55*p[2];
JB->data[621] = -1.1*p[2];
JB->data[648] = - 1.0*(p[3] - 1.0)*p[2] - 1.0*p[2]*p[3];
JB->data[653] = -0.55*p[2];
JB->data[683] = 2.0*(p[3] - 1.0)*p[2];
JB->data[684] = p[4];
JB->data[688] = -0.45*p[2];
JB->data[717] = 2.0*(p[3] - 1.0)*p[2];
JB->data[718] = -2.0*(p[3] - 1.0)*p[2];
JB->data[720] = p[4] - 1.0*(p[3] - 1.0)*p[2] - 1.0*p[2]*p[3];
JB->data[725] = -0.55*p[2];
JB->data[726] = -0.45*p[2];
JB->data[753] = 4.0*(p[3] - 1.0)*p[2];
JB->data[754] = -1.0*p[4];
JB->data[755] = 4.0*(p[3] - 1.0)*p[2];
JB->data[756] = 2.0*p[4];
...
JB->data[900] = p[4];
JB->data[901] = 2.0*(p[3] - 1.0)*p[2];
JB->data[902] = -1.0*p[2];
JB->data[922] = -1.0*p[2];
JB->data[934] = -0.55*p[2];
JB->data[936] = - 1.0*(p[3] - 1.0)*p[2] - 1.0*p[2]*p[3];
JB->data[957] = 2.0*(p[3] - 1.0)*p[2];
JB->data[972] = p[1] + p[4];
...
JB->data[1116] = p[0] - 1.0*(p[3] - 1.0)*p[2] - 1.0*p[2]*p[3];
...
JB->data[1224] = p[0] + p[4];
 ...
 int JSparseB__sA_sPB_3o_2B_S_atS__T_atS__B_stS(realtype t, N_Vector x,
  	...
  	N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B)
{
 ...
 int sx__sA_sPB_3o_2B_S_atS__T_atS__B_stS(int Ns, realtype t, N_Vector x, N_Vector xdot,
  	...
  	N_Vector tmp1, N_Vector tmp2)
{
  ...
  switch (plist[ip]) {
  case 0: {
sxdot_tmp[0] = 0.55*p[2]*sx_tmp[29] + sx_tmp[0]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
...
sxdot_tmp[3] = 0.45*p[2]*sx_tmp[29] - 1.0*(p[4] + 0.0002)*sx_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[0];
...
sxdot_tmp[15] = 0.55*p[2]*sx_tmp[22] + p[4]*sx_tmp[20] + sx_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
sxdot_tmp[16] = 0.45*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[19] + p[4]*sx_tmp[21] - 1.0*sx_tmp[16]*(p[4] + p[5]) - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[15];
sxdot_tmp[17] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26] - 1.0*((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*sx_tmp[18] + (2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*sx_tmp[17];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[23] + sx_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[19] = 0.45*p[2]*sx_tmp[23] - 1.0*p[4]*sx_tmp[19] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[20] = 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26] + sx_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[17] + 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[21] = p[4]*sx_tmp[19] + 0.45*p[2]*sx_tmp[23] - 2.0*p[4]*sx_tmp[21] + 0.9*p[2]*sx_tmp[25] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[18] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[20];
...
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[27] - 1.0*p[4]*sx_tmp[25] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[26];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24] + sx_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[27] = p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[4]) + x_tmp[34] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[12];
...
sxdot_tmp[31] = p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[30] + sx_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) + 0.0002*sx_tmp[0] - 1.0*x_tmp[31];
...
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] - 1.0*sx_tmp[34]*(p[0] + p[4]) + 0.0002*sx_tmp[3] - 1.0*x_tmp[34] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[31];
...
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[27] - 1.0*p[4]*sx_tmp[25] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[26];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24] + sx_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[27] = p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[4]) - 1.0*x_tmp[27] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[12];
...
sxdot_tmp[31] = p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[30] + sx_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) + 0.0002*sx_tmp[0] + x_tmp[12];
...
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] - 1.0*sx_tmp[34]*(p[0] + p[4]) + 0.0002*sx_tmp[3] + x_tmp[27] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[31];

  } break;

  case 2: {
sxdot_tmp[0] = 0.55*p[2]*sx_tmp[29] + p[3]*x_tmp[0] + sx_tmp[0]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002) + (p[3] - 1.0)*x_tmp[0] + 0.55*x_tmp[29];
sxdot_tmp[1] = p[4]*sx_tmp[3] - 1.0*(p[5] + 0.0002)*sx_tmp[1];
sxdot_tmp[2] = p[1]*sx_tmp[33] + p[4]*sx_tmp[34] - 1.0*sx_tmp[2]*(p[0] + p[5]) + 0.0002*sx_tmp[1];
sxdot_tmp[3] = 0.45*p[2]*sx_tmp[29] - 2.0*(p[3] - 1.0)*x_tmp[0] - 1.0*(p[4] + 0.0002)*sx_tmp[3] + 0.45*x_tmp[29] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[0];
sxdot_tmp[4] = 0.0002*sx_tmp[6] - 0.0004*sx_tmp[4];
...
sxdot_tmp[13] = p[4]*sx_tmp[19] - 1.0*p[5]*sx_tmp[13];
sxdot_tmp[14] = p[5]*sx_tmp[13] - 2.0*p[5]*sx_tmp[14] + 2.0*p[4]*sx_tmp[16] + p[4]*sx_tmp[19];
sxdot_tmp[15] = 0.55*p[2]*sx_tmp[22] + p[4]*sx_tmp[20] + p[3]*x_tmp[15] + sx_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]) + (p[3] - 1.0)*x_tmp[15] + 0.55*x_tmp[22];
sxdot_tmp[16] = 0.45*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[19] + p[4]*sx_tmp[21] - 1.0*sx_tmp[16]*(p[4] + p[5]) - 2.0*(p[3] - 1.0)*x_tmp[15] + 0.45*x_tmp[22] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[15];
sxdot_tmp[17] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26] + 2.0*p[3]*x_tmp[17] + p[3]*x_tmp[18] - 1.0*((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*sx_tmp[18] + 2.0*(p[3] - 1.0)*x_tmp[17] - 1.0*(p[3] - 1.0)*x_tmp[18] + (2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*sx_tmp[17] + 0.55*x_tmp[23] + 1.1*x_tmp[26];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[23] + p[3]*x_tmp[18] + sx_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + (p[3] - 1.0)*x_tmp[18] + 0.55*x_tmp[23];
sxdot_tmp[19] = 0.45*p[2]*sx_tmp[23] - 1.0*p[4]*sx_tmp[19] - 2.0*(p[3] - 1.0)*x_tmp[18] + 0.45*x_tmp[23] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[20] = 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26] + p[3]*x_tmp[20] + sx_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 2.0*(p[3] - 1.0)*x_tmp[17] + 2.0*(p[3] - 1.0)*x_tmp[18] + (p[3] - 1.0)*x_tmp[20] + 0.55*x_tmp[25] + 0.45*x_tmp[26] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[17] + 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[21] = p[4]*sx_tmp[19] + 0.45*p[2]*sx_tmp[23] - 2.0*p[4]*sx_tmp[21] + 0.9*p[2]*sx_tmp[25] - 4.0*(p[3] - 1.0)*x_tmp[18] - 4.0*(p[3] - 1.0)*x_tmp[20] + 0.45*x_tmp[23] + 0.9*x_tmp[25] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[18] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[20];
...
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[27] - 1.0*p[4]*sx_tmp[25] - 2.0*(p[3] - 1.0)*x_tmp[26] + 0.45*x_tmp[24] + x_tmp[27] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[26];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24] + p[3]*x_tmp[26] + sx_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]) + (p[3] - 1.0)*x_tmp[26] + x_tmp[12] + 0.55*x_tmp[24];
sxdot_tmp[27] = p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[4]) - 2.0*(p[3] - 1.0)*x_tmp[12] + 0.45*x_tmp[32] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[12];
...
sxdot_tmp[31] = p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[30] + p[3]*x_tmp[31] + sx_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) + (p[3] - 1.0)*x_tmp[31] + 0.0002*sx_tmp[0] + 0.55*x_tmp[30];
...
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] - 1.0*sx_tmp[34]*(p[0] + p[4]) - 2.0*(p[3] - 1.0)*x_tmp[31] + 0.0002*sx_tmp[3] + 0.45*x_tmp[30] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[31];

  } break;

  case 3: {
sxdot_tmp[0] = 0.55*p[2]*sx_tmp[29] + 2.0*p[2]*x_tmp[0] + sx_tmp[0]*((p[3] - 1.0)*p[2] + p[2]*p[3] - 0.0002);
sxdot_tmp[1] = p[4]*sx_tmp[3] - 1.0*(p[5] + 0.0002)*sx_tmp[1];
sxdot_tmp[2] = p[1]*sx_tmp[33] + p[4]*sx_tmp[34] - 1.0*sx_tmp[2]*(p[0] + p[5]) + 0.0002*sx_tmp[1];
sxdot_tmp[3] = 0.45*p[2]*sx_tmp[29] - 2.0*p[2]*x_tmp[0] - 1.0*(p[4] + 0.0002)*sx_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[0];
sxdot_tmp[4] = 0.0002*sx_tmp[6] - 0.0004*sx_tmp[4];
sxdot_tmp[5] = p[1]*sx_tmp[7] - 1.0*(p[0] + 0.0002)*sx_tmp[5] + 0.0002*sx_tmp[4] - 0.0002*sx_tmp[6];
sxdot_tmp[6] = -0.0002*sx_tmp[6];
sxdot_tmp[7] = p[0]*sx_tmp[5] - 1.0*(p[1] + 0.0002)*sx_tmp[7];
...
sxdot_tmp[13] = p[4]*sx_tmp[19] - 1.0*p[5]*sx_tmp[13];
sxdot_tmp[14] = p[5]*sx_tmp[13] - 2.0*p[5]*sx_tmp[14] + 2.0*p[4]*sx_tmp[16] + p[4]*sx_tmp[19];
sxdot_tmp[15] = 0.55*p[2]*sx_tmp[22] + p[4]*sx_tmp[20] + 2.0*p[2]*x_tmp[15] + sx_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]);
sxdot_tmp[16] = 0.45*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[19] + p[4]*sx_tmp[21] - 2.0*p[2]*x_tmp[15] - 1.0*sx_tmp[16]*(p[4] + p[5]) - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[15];
sxdot_tmp[17] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26] + 4.0*p[2]*x_tmp[17] - 1.0*((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*sx_tmp[18] + (2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*sx_tmp[17];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[23] + 2.0*p[2]*x_tmp[18] + sx_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[19] = 0.45*p[2]*sx_tmp[23] - 1.0*p[4]*sx_tmp[19] - 2.0*p[2]*x_tmp[18] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[20] = 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26] - 2.0*p[2]*x_tmp[17] + 2.0*p[2]*x_tmp[18] + 2.0*p[2]*x_tmp[20] + sx_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[17] + 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[21] = p[4]*sx_tmp[19] + 0.45*p[2]*sx_tmp[23] - 2.0*p[4]*sx_tmp[21] + 0.9*p[2]*sx_tmp[25] - 4.0*p[2]*x_tmp[18] - 4.0*p[2]*x_tmp[20] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[18] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[20];
sxdot_tmp[22] = p[4]*sx_tmp[25] - 1.0*p[5]*sx_tmp[22] + p[2]*sx_tmp[33];
sxdot_tmp[23] = p[2]*sx_tmp[28];
sxdot_tmp[24] = p[2]*sx_tmp[28] + 2.0*p[2]*sx_tmp[32];
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[27] - 1.0*p[4]*sx_tmp[25] - 2.0*p[2]*x_tmp[26] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[26];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24] + 2.0*p[2]*x_tmp[26] + sx_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[27] = p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 2.0*p[2]*x_tmp[12] - 1.0*sx_tmp[27]*(p[1] + p[4]) - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[12];
sxdot_tmp[28] = p[0]*sx_tmp[9] - 1.0*p[1]*sx_tmp[28];
sxdot_tmp[29] = p[2]*sx_tmp[7] - 0.0002*sx_tmp[29];
sxdot_tmp[30] = p[2]*sx_tmp[11] - 1.0*p[0]*sx_tmp[30] + p[1]*sx_tmp[32] + 0.0002*sx_tmp[29];
sxdot_tmp[31] = p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[30] + 2.0*p[2]*x_tmp[31] + sx_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) + 0.0002*sx_tmp[0];
sxdot_tmp[32] = p[2]*sx_tmp[10] + p[0]*sx_tmp[30] - 1.0*p[1]*sx_tmp[32];
sxdot_tmp[33] = p[0]*sx_tmp[2] + p[4]*sx_tmp[27] - 1.0*sx_tmp[33]*(p[1] + p[5]);
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] - 2.0*p[2]*x_tmp[31] - 1.0*sx_tmp[34]*(p[0] + p[4]) + 0.0002*sx_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[31];
...
sxdot_tmp[3] = 0.45*p[2]*sx_tmp[29] - 1.0*(p[4] + 0.0002)*sx_tmp[3] - 1.0*x_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[0];
sxdot_tmp[4] = 0.0002*sx_tmp[6] - 0.0004*sx_tmp[4];
sxdot_tmp[5] = p[1]*sx_tmp[7] - 1.0*(p[0] + 0.0002)*sx_tmp[5] + 0.0002*sx_tmp[4] - 0.0002*sx_tmp[6];
sxdot_tmp[6] = -0.0002*sx_tmp[6];
sxdot_tmp[7] = p[0]*sx_tmp[5] - 1.0*(p[1] + 0.0002)*sx_tmp[7];
...
sxdot_tmp[15] = 0.55*p[2]*sx_tmp[22] + p[4]*sx_tmp[20] + sx_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]) + x_tmp[20];
sxdot_tmp[16] = 0.45*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[19] + p[4]*sx_tmp[21] - 1.0*sx_tmp[16]*(p[4] + p[5]) - 1.0*x_tmp[16] - 1.0*x_tmp[19] + x_tmp[21] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[15];
sxdot_tmp[17] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26] - 1.0*((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*sx_tmp[18] + (2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*sx_tmp[17];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[23] + sx_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[19] = 0.45*p[2]*sx_tmp[23] - 1.0*p[4]*sx_tmp[19] - 1.0*x_tmp[19] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[20] = 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26] + sx_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 1.0*x_tmp[20] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[17] + 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[21] = p[4]*sx_tmp[19] + 0.45*p[2]*sx_tmp[23] - 2.0*p[4]*sx_tmp[21] + 0.9*p[2]*sx_tmp[25] + x_tmp[19] - 2.0*x_tmp[21] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[18] - 4.0*(p[3] - 1.0)*p[2]*sx_tmp[20];
sxdot_tmp[22] = p[4]*sx_tmp[25] - 1.0*p[5]*sx_tmp[22] + p[2]*sx_tmp[33] + x_tmp[25];
sxdot_tmp[23] = p[2]*sx_tmp[28];
sxdot_tmp[24] = p[2]*sx_tmp[28] + 2.0*p[2]*sx_tmp[32];
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[27] - 1.0*p[4]*sx_tmp[25] - 1.0*x_tmp[25] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[26];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24] + sx_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[27] = p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[4]) - 1.0*x_tmp[27] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[12];
sxdot_tmp[28] = p[0]*sx_tmp[9] - 1.0*p[1]*sx_tmp[28];
sxdot_tmp[29] = p[2]*sx_tmp[7] - 0.0002*sx_tmp[29];
sxdot_tmp[30] = p[2]*sx_tmp[11] - 1.0*p[0]*sx_tmp[30] + p[1]*sx_tmp[32] + 0.0002*sx_tmp[29];
sxdot_tmp[31] = p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[30] + sx_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) + 0.0002*sx_tmp[0];
sxdot_tmp[32] = p[2]*sx_tmp[10] + p[0]*sx_tmp[30] - 1.0*p[1]*sx_tmp[32];
...
sxdot_tmp[15] = 0.55*p[2]*sx_tmp[22] + p[4]*sx_tmp[20] + sx_tmp[15]*((p[3] - 1.0)*p[2] - 1.0*p[5] + p[2]*p[3]) - 1.0*x_tmp[15];
sxdot_tmp[16] = 0.45*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[19] + p[4]*sx_tmp[21] - 1.0*sx_tmp[16]*(p[4] + p[5]) - 1.0*x_tmp[16] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[15];
sxdot_tmp[17] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26] - 1.0*((p[3] - 1.0)*p[2] - 1.0*p[2]*p[3])*sx_tmp[18] + (2.0*(p[3] - 1.0)*p[2] + 2.0*p[2]*p[3])*sx_tmp[17];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[23] + sx_tmp[18]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[19] = 0.45*p[2]*sx_tmp[23] - 1.0*p[4]*sx_tmp[19] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
sxdot_tmp[20] = 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26] + sx_tmp[20]*((p[3] - 1.0)*p[2] - 1.0*p[4] + p[2]*p[3]) - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[17] + 2.0*(p[3] - 1.0)*p[2]*sx_tmp[18];
...
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[27] - 1.0*p[4]*sx_tmp[25] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[26];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24] + sx_tmp[26]*((p[3] - 1.0)*p[2] + p[2]*p[3]);
sxdot_tmp[27] = p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[4]) - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[12];
sxdot_tmp[28] = p[0]*sx_tmp[9] - 1.0*p[1]*sx_tmp[28];
sxdot_tmp[29] = p[2]*sx_tmp[7] - 0.0002*sx_tmp[29];
sxdot_tmp[30] = p[2]*sx_tmp[11] - 1.0*p[0]*sx_tmp[30] + p[1]*sx_tmp[32] + 0.0002*sx_tmp[29];
sxdot_tmp[31] = p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[30] + sx_tmp[31]*((p[3] - 1.0)*p[2] - 1.0*p[0] + p[2]*p[3]) + 0.0002*sx_tmp[0];
sxdot_tmp[32] = p[2]*sx_tmp[10] + p[0]*sx_tmp[30] - 1.0*p[1]*sx_tmp[32];
sxdot_tmp[33] = p[0]*sx_tmp[2] + p[4]*sx_tmp[27] - 1.0*sx_tmp[33]*(p[1] + p[5]) - 1.0*x_tmp[33];
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] - 1.0*sx_tmp[34]*(p[0] + p[4]) + 0.0002*sx_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[31];
...
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] - 1.0*sx_tmp[34]*(p[0] + p[4]) + 0.0002*sx_tmp[3] - 2.0*(p[3] - 1.0)*p[2]*sx_tmp[31];
 ...
 void sx0__sA_sPB_3o_2B_S_atS__T_atS__B_stS(int ip, N_Vector sx0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  int *plist = data->plist;
...
void y__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int nt, int it, double *y, double *p, double *k, double *u, double *x){
...
void dydp__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int nt, int it, double *dydp, double *y, double *p, double *k, double *u, double *x, int *plist, int np, int ny){
...
void dydx__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t,double *dydx, double *y, double *p, double *k, double *x){
...
void sy__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int nt, int it, int ip, int np, int nx, int ny, double *sy, double *p, double *k, double *x, double *sx){
  switch (ip) {
  case 0: {
...
int root__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, N_Vector x, realtype *gout, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double sroot__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int ip, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double s2root__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int ip, int jp, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double srootval__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int ip, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double s2rootval__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int ip, int jp, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
void deltadisc__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int idisc, N_Vector x, void *user_data){
  int ix;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
...
void sdeltadisc__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int idisc, N_Vector x, N_Vector *sx, void *user_data){
  int ix;
  int ip;
  UserData data = (UserData) user_data;
  int *plist = data->plist;
...
void dxdotdp__sA_sPB_3o_2B_S_atS__T_atS__B_stS(double t, int nt, int it, double *dxdotdp, double *p, double *k, double *u, double *x, int *plist, int np, int nx){
...
dxdotdp[(34+ip*nx)] = x[it+nt*27];
  ...
  case 2: {
dxdotdp[(0+ip*nx)] = p[3]*x[it+nt*0] + (p[3] - 1.0)*x[it+nt*0] + 0.55*x[it+nt*29];
dxdotdp[(3+ip*nx)] = 0.45*x[it+nt*29] - 2.0*(p[3] - 1.0)*x[it+nt*0];
dxdotdp[(12+ip*nx)] = p[3]*x[it+nt*12] + (p[3] - 1.0)*x[it+nt*12] + 0.55*x[it+nt*32];
dxdotdp[(15+ip*nx)] = p[3]*x[it+nt*15] + (p[3] - 1.0)*x[it+nt*15] + 0.55*x[it+nt*22];
dxdotdp[(16+ip*nx)] = 0.45*x[it+nt*22] - 2.0*(p[3] - 1.0)*x[it+nt*15];
dxdotdp[(17+ip*nx)] = 2.0*p[3]*x[it+nt*17] + p[3]*x[it+nt*18] + 2.0*(p[3] - 1.0)*x[it+nt*17] - 1.0*(p[3] - 1.0)*x[it+nt*18] + 0.55*x[it+nt*23] + 1.1*x[it+nt*26];
dxdotdp[(18+ip*nx)] = p[3]*x[it+nt*18] + (p[3] - 1.0)*x[it+nt*18] + 0.55*x[it+nt*23];
dxdotdp[(19+ip*nx)] = 0.45*x[it+nt*23] - 2.0*(p[3] - 1.0)*x[it+nt*18];
dxdotdp[(20+ip*nx)] = p[3]*x[it+nt*20] - 2.0*(p[3] - 1.0)*x[it+nt*17] + 2.0*(p[3] - 1.0)*x[it+nt*18] + (p[3] - 1.0)*x[it+nt*20] + 0.55*x[it+nt*25] + 0.45*x[it+nt*26];
dxdotdp[(21+ip*nx)] = 0.45*x[it+nt*23] - 4.0*(p[3] - 1.0)*x[it+nt*20] - 4.0*(p[3] - 1.0)*x[it+nt*18] + 0.9*x[it+nt*25];
dxdotdp[(22+ip*nx)] = x[it+nt*33];
dxdotdp[(23+ip*nx)] = x[it+nt*28];
dxdotdp[(24+ip*nx)] = x[it+nt*28] + 2.0*x[it+nt*32];
dxdotdp[(25+ip*nx)] = 0.45*x[it+nt*24] - 2.0*(p[3] - 1.0)*x[it+nt*26] + x[it+nt*27];
dxdotdp[(26+ip*nx)] = p[3]*x[it+nt*26] + (p[3] - 1.0)*x[it+nt*26] + x[it+nt*12] + 0.55*x[it+nt*24];
dxdotdp[(27+ip*nx)] = 0.45*x[it+nt*32] - 2.0*(p[3] - 1.0)*x[it+nt*12];
dxdotdp[(29+ip*nx)] = x[it+nt*7];
dxdotdp[(30+ip*nx)] = x[it+nt*11];
dxdotdp[(31+ip*nx)] = p[3]*x[it+nt*31] + (p[3] - 1.0)*x[it+nt*31] + 0.55*x[it+nt*30];
dxdotdp[(32+ip*nx)] = x[it+nt*10];
dxdotdp[(34+ip*nx)] = 0.45*x[it+nt*30] - 2.0*(p[3] - 1.0)*x[it+nt*31];
