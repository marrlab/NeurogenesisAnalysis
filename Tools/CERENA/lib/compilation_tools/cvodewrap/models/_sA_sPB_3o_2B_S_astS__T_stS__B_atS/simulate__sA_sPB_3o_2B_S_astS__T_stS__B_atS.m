% simulate__sA_sPB_3o_2B_S_astS__T_stS__B_atS.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_atS(tout,theta)
% [...] = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_atS(tout,theta,kappa,options)
% sol = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_atS(...)
% [status,tout,x,y,sx,sy] = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_atS(...)
%
% INPUTS:
% =======
...
function varargout = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_atS(varargin)
...
cw__sA_sPB_3o_2B_S_astS__T_stS__B_atS(sol,tout,theta(1:10),kappa(1:70),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);
