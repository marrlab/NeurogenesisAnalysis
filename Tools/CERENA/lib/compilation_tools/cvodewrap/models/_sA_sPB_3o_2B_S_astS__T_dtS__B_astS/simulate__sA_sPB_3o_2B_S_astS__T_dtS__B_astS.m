% simulate__sA_sPB_3o_2B_S_astS__T_dtS__B_astS.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate__sA_sPB_3o_2B_S_astS__T_dtS__B_astS(tout,theta)
% [...] = simulate__sA_sPB_3o_2B_S_astS__T_dtS__B_astS(tout,theta,kappa,options)
% sol = simulate__sA_sPB_3o_2B_S_astS__T_dtS__B_astS(...)
% [status,tout,x,y,sx,sy] = simulate__sA_sPB_3o_2B_S_astS__T_dtS__B_astS(...)
%
% INPUTS:
% =======
...
function varargout = simulate__sA_sPB_3o_2B_S_astS__T_dtS__B_astS(varargin)
...
cw__sA_sPB_3o_2B_S_astS__T_dtS__B_astS(sol,tout,theta(1:12),kappa(1:70),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);
