#include "_sA_sPB_3o_2B_S_atS__T_atS__B_atS.h"
...
#define pi 3.141592653589793
 ...
 int xdot__sA_sPB_3o_2B_S_atS__T_atS__B_atS(realtype t, N_Vector x, N_Vector xdot, void *user_data)
{
  int ix;
...
xdot_tmp[1] = p[3]*x_tmp[3] - 1.0*p[4]*x_tmp[1] - 0.0002*x_tmp[1];
xdot_tmp[2] = p[1]*x_tmp[33] - 1.0*p[4]*x_tmp[2] - 1.0*p[0]*x_tmp[2] + p[3]*x_tmp[34] + 0.0002*x_tmp[1];
xdot_tmp[3] = p[2]*x_tmp[0] - 1.0*p[3]*x_tmp[3] + 0.45*p[2]*x_tmp[29] - 0.0002*x_tmp[3];
...
xdot_tmp[12] = p[0]*x_tmp[31] - 1.0*p[1]*x_tmp[12] + 0.55*p[2]*x_tmp[32];
xdot_tmp[13] = 0.55*p[2]*x_tmp[23] + 1.1*p[2]*x_tmp[26];
xdot_tmp[14] = p[3]*x_tmp[17] - 1.0*p[4]*x_tmp[14];
xdot_tmp[15] = p[4]*x_tmp[14] - 2.0*p[4]*x_tmp[15] + p[3]*x_tmp[17] + 2.0*p[3]*x_tmp[19];
xdot_tmp[16] = 0.55*p[2]*x_tmp[23];
xdot_tmp[17] = p[2]*x_tmp[16] - 1.0*p[3]*x_tmp[17] + 0.45*p[2]*x_tmp[23];
xdot_tmp[18] = 0.55*p[2]*x_tmp[22] - 1.0*p[4]*x_tmp[18] + p[3]*x_tmp[21];
xdot_tmp[19] = p[2]*x_tmp[18] - 1.0*p[3]*x_tmp[17] - 1.0*p[3]*x_tmp[19] + p[3]*x_tmp[20] - 1.0*p[4]*x_tmp[19] + 0.45*p[2]*x_tmp[22];
xdot_tmp[20] = p[2]*x_tmp[16] + p[3]*x_tmp[17] + 2.0*p[2]*x_tmp[21] - 2.0*p[3]*x_tmp[20] + 0.45*p[2]*x_tmp[23] + 0.9*p[2]*x_tmp[25];
xdot_tmp[21] = p[2]*x_tmp[13] - 1.0*p[3]*x_tmp[21] + 0.55*p[2]*x_tmp[25] + 0.45*p[2]*x_tmp[26];
xdot_tmp[22] = p[3]*x_tmp[25] - 1.0*p[4]*x_tmp[22] + p[2]*x_tmp[33];
xdot_tmp[23] = p[2]*x_tmp[28];
xdot_tmp[24] = p[2]*x_tmp[28] + 2.0*p[2]*x_tmp[32];
xdot_tmp[25] = 0.45*p[2]*x_tmp[24] + p[2]*x_tmp[26] - 1.0*p[3]*x_tmp[25] + p[2]*x_tmp[27];
xdot_tmp[26] = p[2]*x_tmp[12] + 0.55*p[2]*x_tmp[24];
xdot_tmp[27] = p[2]*x_tmp[12] - 1.0*p[1]*x_tmp[27] - 1.0*p[3]*x_tmp[27] + p[0]*x_tmp[34] + 0.45*p[2]*x_tmp[32];
...
xdot_tmp[33] = p[0]*x_tmp[2] + p[3]*x_tmp[27] - 1.0*p[1]*x_tmp[33] - 1.0*p[4]*x_tmp[33];
xdot_tmp[34] = p[1]*x_tmp[27] + 0.45*p[2]*x_tmp[30] + p[2]*x_tmp[31] - 1.0*p[0]*x_tmp[34] - 1.0*p[3]*x_tmp[34] + 0.0002*x_tmp[3];
 ...
 int xBdot__sA_sPB_3o_2B_S_atS__T_atS__B_atS(realtype t, N_Vector x, N_Vector xB, N_Vector xBdot, void *user_data)
{
  int ixB;
  UserData data = (UserData) user_data;
  double *p = data->p;
...
xBdot_tmp[1] = (p[4] + 0.0002)*xB_tmp[1] - 0.0002*xB_tmp[2];
xBdot_tmp[2] = xB_tmp[2]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[33];
xBdot_tmp[3] = (p[3] + 0.0002)*xB_tmp[3] - 1.0*p[3]*xB_tmp[1] - 0.0002*xB_tmp[34];
...
xBdot_tmp[12] = p[1]*xB_tmp[12] - 1.0*p[2]*xB_tmp[26] - 1.0*p[2]*xB_tmp[27] - 1.0*p[1]*xB_tmp[31];
xBdot_tmp[13] = -1.0*p[2]*xB_tmp[21];
xBdot_tmp[14] = p[4]*xB_tmp[14] - 1.0*p[4]*xB_tmp[15];
xBdot_tmp[15] = 2.0*p[4]*xB_tmp[15];
xBdot_tmp[16] = - 1.0*p[2]*xB_tmp[17] - 1.0*p[2]*xB_tmp[20];
xBdot_tmp[17] = p[3]*xB_tmp[17] - 1.0*p[3]*xB_tmp[15] - 1.0*p[3]*xB_tmp[14] + p[3]*xB_tmp[19] - 1.0*p[3]*xB_tmp[20];
xBdot_tmp[18] = p[4]*xB_tmp[18] - 1.0*p[2]*xB_tmp[19];
xBdot_tmp[19] = xB_tmp[19]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[15];
xBdot_tmp[20] = 2.0*p[3]*xB_tmp[20] - 1.0*p[3]*xB_tmp[19];
xBdot_tmp[21] = p[3]*xB_tmp[21] - 2.0*p[2]*xB_tmp[20] - 1.0*p[3]*xB_tmp[18];
xBdot_tmp[22] = p[4]*xB_tmp[22] - 0.45*p[2]*xB_tmp[19] - 0.55*p[2]*xB_tmp[18];
...
xBdot_tmp[25] = p[3]*xB_tmp[25] - 0.55*p[2]*xB_tmp[21] - 1.0*p[3]*xB_tmp[22] - 0.9*p[2]*xB_tmp[20];
xBdot_tmp[26] = - 1.1*p[2]*xB_tmp[13] - 0.45*p[2]*xB_tmp[21] - 1.0*p[2]*xB_tmp[25];
xBdot_tmp[27] = xB_tmp[27]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[34] - 1.0*p[3]*xB_tmp[33] - 1.0*p[2]*xB_tmp[25];
...
xBdot_tmp[33] = xB_tmp[33]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[22] - 1.0*p[1]*xB_tmp[2];
xBdot_tmp[34] = xB_tmp[34]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[27] - 1.0*p[3]*xB_tmp[2];
xBdot_tmp[35] = 0.0002*xB_tmp[35] - 1.0*p[2]*xB_tmp[38] - 0.0002*xB_tmp[66];
xBdot_tmp[36] = (p[4] + 0.0002)*xB_tmp[36] - 0.0002*xB_tmp[37];
xBdot_tmp[37] = xB_tmp[37]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[68];
xBdot_tmp[38] = (p[3] + 0.0002)*xB_tmp[38] - 1.0*p[3]*xB_tmp[36] - 0.0002*xB_tmp[69];
...
xBdot_tmp[47] = p[1]*xB_tmp[47] - 1.0*p[2]*xB_tmp[61] - 1.0*p[2]*xB_tmp[62] - 1.0*p[1]*xB_tmp[66];
xBdot_tmp[48] = -1.0*p[2]*xB_tmp[56];
xBdot_tmp[49] = p[4]*xB_tmp[49] - 1.0*p[4]*xB_tmp[50];
xBdot_tmp[50] = 2.0*p[4]*xB_tmp[50];
xBdot_tmp[51] = - 1.0*p[2]*xB_tmp[52] - 1.0*p[2]*xB_tmp[55];
xBdot_tmp[52] = p[3]*xB_tmp[52] - 1.0*p[3]*xB_tmp[50] - 1.0*p[3]*xB_tmp[49] + p[3]*xB_tmp[54] - 1.0*p[3]*xB_tmp[55];
xBdot_tmp[53] = p[4]*xB_tmp[53] - 1.0*p[2]*xB_tmp[54];
xBdot_tmp[54] = xB_tmp[54]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[50];
xBdot_tmp[55] = 2.0*p[3]*xB_tmp[55] - 1.0*p[3]*xB_tmp[54];
xBdot_tmp[56] = p[3]*xB_tmp[56] - 2.0*p[2]*xB_tmp[55] - 1.0*p[3]*xB_tmp[53];
xBdot_tmp[57] = p[4]*xB_tmp[57] - 0.45*p[2]*xB_tmp[54] - 0.55*p[2]*xB_tmp[53];
...
xBdot_tmp[60] = p[3]*xB_tmp[60] - 0.55*p[2]*xB_tmp[56] - 1.0*p[3]*xB_tmp[57] - 0.9*p[2]*xB_tmp[55];
xBdot_tmp[61] = - 1.1*p[2]*xB_tmp[48] - 0.45*p[2]*xB_tmp[56] - 1.0*p[2]*xB_tmp[60];
xBdot_tmp[62] = xB_tmp[62]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[69] - 1.0*p[3]*xB_tmp[68] - 1.0*p[2]*xB_tmp[60];
...
xBdot_tmp[68] = xB_tmp[68]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[57] - 1.0*p[1]*xB_tmp[37];
xBdot_tmp[69] = xB_tmp[69]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[62] - 1.0*p[3]*xB_tmp[37];
xBdot_tmp[70] = 0.0002*xB_tmp[70] - 1.0*p[2]*xB_tmp[73] - 0.0002*xB_tmp[101];
xBdot_tmp[71] = (p[4] + 0.0002)*xB_tmp[71] - 0.0002*xB_tmp[72];
xBdot_tmp[72] = xB_tmp[72]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[103];
xBdot_tmp[73] = (p[3] + 0.0002)*xB_tmp[73] - 1.0*p[3]*xB_tmp[71] - 0.0002*xB_tmp[104];
...
xBdot_tmp[82] = p[1]*xB_tmp[82] - 1.0*p[2]*xB_tmp[96] - 1.0*p[2]*xB_tmp[97] - 1.0*p[1]*xB_tmp[101];
xBdot_tmp[83] = -1.0*p[2]*xB_tmp[91];
xBdot_tmp[84] = p[4]*xB_tmp[84] - 1.0*p[4]*xB_tmp[85];
xBdot_tmp[85] = 2.0*p[4]*xB_tmp[85];
xBdot_tmp[86] = - 1.0*p[2]*xB_tmp[87] - 1.0*p[2]*xB_tmp[90];
xBdot_tmp[87] = p[3]*xB_tmp[87] - 1.0*p[3]*xB_tmp[85] - 1.0*p[3]*xB_tmp[84] + p[3]*xB_tmp[89] - 1.0*p[3]*xB_tmp[90];
xBdot_tmp[88] = p[4]*xB_tmp[88] - 1.0*p[2]*xB_tmp[89];
xBdot_tmp[89] = xB_tmp[89]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[85];
xBdot_tmp[90] = 2.0*p[3]*xB_tmp[90] - 1.0*p[3]*xB_tmp[89];
xBdot_tmp[91] = p[3]*xB_tmp[91] - 2.0*p[2]*xB_tmp[90] - 1.0*p[3]*xB_tmp[88];
xBdot_tmp[92] = p[4]*xB_tmp[92] - 0.45*p[2]*xB_tmp[89] - 0.55*p[2]*xB_tmp[88];
...
xBdot_tmp[95] = p[3]*xB_tmp[95] - 0.55*p[2]*xB_tmp[91] - 1.0*p[3]*xB_tmp[92] - 0.9*p[2]*xB_tmp[90];
xBdot_tmp[96] = - 1.1*p[2]*xB_tmp[83] - 0.45*p[2]*xB_tmp[91] - 1.0*p[2]*xB_tmp[95];
xBdot_tmp[97] = xB_tmp[97]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[104] - 1.0*p[3]*xB_tmp[103] - 1.0*p[2]*xB_tmp[95];
...
xBdot_tmp[103] = xB_tmp[103]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[92] - 1.0*p[1]*xB_tmp[72];
xBdot_tmp[104] = xB_tmp[104]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[97] - 1.0*p[3]*xB_tmp[72];
xBdot_tmp[105] = 0.0002*xB_tmp[105] - 1.0*p[2]*xB_tmp[108] - 0.0002*xB_tmp[136];
xBdot_tmp[106] = (p[4] + 0.0002)*xB_tmp[106] - 0.0002*xB_tmp[107];
xBdot_tmp[107] = xB_tmp[107]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[138];
xBdot_tmp[108] = (p[3] + 0.0002)*xB_tmp[108] - 1.0*p[3]*xB_tmp[106] - 0.0002*xB_tmp[139];
...
xBdot_tmp[117] = p[1]*xB_tmp[117] - 1.0*p[2]*xB_tmp[131] - 1.0*p[2]*xB_tmp[132] - 1.0*p[1]*xB_tmp[136];
xBdot_tmp[118] = -1.0*p[2]*xB_tmp[126];
xBdot_tmp[119] = p[4]*xB_tmp[119] - 1.0*p[4]*xB_tmp[120];
xBdot_tmp[120] = 2.0*p[4]*xB_tmp[120];
xBdot_tmp[121] = - 1.0*p[2]*xB_tmp[122] - 1.0*p[2]*xB_tmp[125];
xBdot_tmp[122] = p[3]*xB_tmp[122] - 1.0*p[3]*xB_tmp[120] - 1.0*p[3]*xB_tmp[119] + p[3]*xB_tmp[124] - 1.0*p[3]*xB_tmp[125];
xBdot_tmp[123] = p[4]*xB_tmp[123] - 1.0*p[2]*xB_tmp[124];
xBdot_tmp[124] = xB_tmp[124]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[120];
xBdot_tmp[125] = 2.0*p[3]*xB_tmp[125] - 1.0*p[3]*xB_tmp[124];
xBdot_tmp[126] = p[3]*xB_tmp[126] - 2.0*p[2]*xB_tmp[125] - 1.0*p[3]*xB_tmp[123];
xBdot_tmp[127] = p[4]*xB_tmp[127] - 0.45*p[2]*xB_tmp[124] - 0.55*p[2]*xB_tmp[123];
...
xBdot_tmp[130] = p[3]*xB_tmp[130] - 0.55*p[2]*xB_tmp[126] - 1.0*p[3]*xB_tmp[127] - 0.9*p[2]*xB_tmp[125];
xBdot_tmp[131] = - 1.1*p[2]*xB_tmp[118] - 0.45*p[2]*xB_tmp[126] - 1.0*p[2]*xB_tmp[130];
xBdot_tmp[132] = xB_tmp[132]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[139] - 1.0*p[3]*xB_tmp[138] - 1.0*p[2]*xB_tmp[130];
...
xBdot_tmp[138] = xB_tmp[138]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[127] - 1.0*p[1]*xB_tmp[107];
xBdot_tmp[139] = xB_tmp[139]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[132] - 1.0*p[3]*xB_tmp[107];
xBdot_tmp[140] = 0.0002*xB_tmp[140] - 1.0*p[2]*xB_tmp[143] - 0.0002*xB_tmp[171];
xBdot_tmp[141] = (p[4] + 0.0002)*xB_tmp[141] - 0.0002*xB_tmp[142];
xBdot_tmp[142] = xB_tmp[142]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[173];
xBdot_tmp[143] = (p[3] + 0.0002)*xB_tmp[143] - 1.0*p[3]*xB_tmp[141] - 0.0002*xB_tmp[174];
...
xBdot_tmp[152] = p[1]*xB_tmp[152] - 1.0*p[2]*xB_tmp[166] - 1.0*p[2]*xB_tmp[167] - 1.0*p[1]*xB_tmp[171];
xBdot_tmp[153] = -1.0*p[2]*xB_tmp[161];
xBdot_tmp[154] = p[4]*xB_tmp[154] - 1.0*p[4]*xB_tmp[155];
xBdot_tmp[155] = 2.0*p[4]*xB_tmp[155];
xBdot_tmp[156] = - 1.0*p[2]*xB_tmp[157] - 1.0*p[2]*xB_tmp[160];
xBdot_tmp[157] = p[3]*xB_tmp[157] - 1.0*p[3]*xB_tmp[155] - 1.0*p[3]*xB_tmp[154] + p[3]*xB_tmp[159] - 1.0*p[3]*xB_tmp[160];
xBdot_tmp[158] = p[4]*xB_tmp[158] - 1.0*p[2]*xB_tmp[159];
xBdot_tmp[159] = xB_tmp[159]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[155];
xBdot_tmp[160] = 2.0*p[3]*xB_tmp[160] - 1.0*p[3]*xB_tmp[159];
xBdot_tmp[161] = p[3]*xB_tmp[161] - 2.0*p[2]*xB_tmp[160] - 1.0*p[3]*xB_tmp[158];
xBdot_tmp[162] = p[4]*xB_tmp[162] - 0.45*p[2]*xB_tmp[159] - 0.55*p[2]*xB_tmp[158];
...
xBdot_tmp[165] = p[3]*xB_tmp[165] - 0.55*p[2]*xB_tmp[161] - 1.0*p[3]*xB_tmp[162] - 0.9*p[2]*xB_tmp[160];
xBdot_tmp[166] = - 1.1*p[2]*xB_tmp[153] - 0.45*p[2]*xB_tmp[161] - 1.0*p[2]*xB_tmp[165];
xBdot_tmp[167] = xB_tmp[167]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[174] - 1.0*p[3]*xB_tmp[173] - 1.0*p[2]*xB_tmp[165];
...
xBdot_tmp[173] = xB_tmp[173]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[162] - 1.0*p[1]*xB_tmp[142];
xBdot_tmp[174] = xB_tmp[174]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[167] - 1.0*p[3]*xB_tmp[142];
xBdot_tmp[175] = 0.0002*xB_tmp[175] - 1.0*p[2]*xB_tmp[178] - 0.0002*xB_tmp[206];
xBdot_tmp[176] = (p[4] + 0.0002)*xB_tmp[176] - 0.0002*xB_tmp[177];
xBdot_tmp[177] = xB_tmp[177]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[208];
xBdot_tmp[178] = (p[3] + 0.0002)*xB_tmp[178] - 1.0*p[3]*xB_tmp[176] - 0.0002*xB_tmp[209];
...
xBdot_tmp[187] = p[1]*xB_tmp[187] - 1.0*p[2]*xB_tmp[201] - 1.0*p[2]*xB_tmp[202] - 1.0*p[1]*xB_tmp[206];
xBdot_tmp[188] = -1.0*p[2]*xB_tmp[196];
xBdot_tmp[189] = p[4]*xB_tmp[189] - 1.0*p[4]*xB_tmp[190];
xBdot_tmp[190] = 2.0*p[4]*xB_tmp[190];
xBdot_tmp[191] = - 1.0*p[2]*xB_tmp[192] - 1.0*p[2]*xB_tmp[195];
xBdot_tmp[192] = p[3]*xB_tmp[192] - 1.0*p[3]*xB_tmp[190] - 1.0*p[3]*xB_tmp[189] + p[3]*xB_tmp[194] - 1.0*p[3]*xB_tmp[195];
xBdot_tmp[193] = p[4]*xB_tmp[193] - 1.0*p[2]*xB_tmp[194];
xBdot_tmp[194] = xB_tmp[194]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[190];
xBdot_tmp[195] = 2.0*p[3]*xB_tmp[195] - 1.0*p[3]*xB_tmp[194];
xBdot_tmp[196] = p[3]*xB_tmp[196] - 2.0*p[2]*xB_tmp[195] - 1.0*p[3]*xB_tmp[193];
xBdot_tmp[197] = p[4]*xB_tmp[197] - 0.45*p[2]*xB_tmp[194] - 0.55*p[2]*xB_tmp[193];
...
xBdot_tmp[200] = p[3]*xB_tmp[200] - 0.55*p[2]*xB_tmp[196] - 1.0*p[3]*xB_tmp[197] - 0.9*p[2]*xB_tmp[195];
xBdot_tmp[201] = - 1.1*p[2]*xB_tmp[188] - 0.45*p[2]*xB_tmp[196] - 1.0*p[2]*xB_tmp[200];
xBdot_tmp[202] = xB_tmp[202]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[209] - 1.0*p[3]*xB_tmp[208] - 1.0*p[2]*xB_tmp[200];
...
xBdot_tmp[208] = xB_tmp[208]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[197] - 1.0*p[1]*xB_tmp[177];
xBdot_tmp[209] = xB_tmp[209]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[202] - 1.0*p[3]*xB_tmp[177];
xBdot_tmp[210] = 0.0002*xB_tmp[210] - 1.0*p[2]*xB_tmp[213] - 0.0002*xB_tmp[241];
xBdot_tmp[211] = (p[4] + 0.0002)*xB_tmp[211] - 0.0002*xB_tmp[212];
xBdot_tmp[212] = xB_tmp[212]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[243];
xBdot_tmp[213] = (p[3] + 0.0002)*xB_tmp[213] - 1.0*p[3]*xB_tmp[211] - 0.0002*xB_tmp[244];
...
xBdot_tmp[222] = p[1]*xB_tmp[222] - 1.0*p[2]*xB_tmp[236] - 1.0*p[2]*xB_tmp[237] - 1.0*p[1]*xB_tmp[241];
xBdot_tmp[223] = -1.0*p[2]*xB_tmp[231];
xBdot_tmp[224] = p[4]*xB_tmp[224] - 1.0*p[4]*xB_tmp[225];
xBdot_tmp[225] = 2.0*p[4]*xB_tmp[225];
xBdot_tmp[226] = - 1.0*p[2]*xB_tmp[227] - 1.0*p[2]*xB_tmp[230];
xBdot_tmp[227] = p[3]*xB_tmp[227] - 1.0*p[3]*xB_tmp[225] - 1.0*p[3]*xB_tmp[224] + p[3]*xB_tmp[229] - 1.0*p[3]*xB_tmp[230];
xBdot_tmp[228] = p[4]*xB_tmp[228] - 1.0*p[2]*xB_tmp[229];
xBdot_tmp[229] = xB_tmp[229]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[225];
xBdot_tmp[230] = 2.0*p[3]*xB_tmp[230] - 1.0*p[3]*xB_tmp[229];
xBdot_tmp[231] = p[3]*xB_tmp[231] - 2.0*p[2]*xB_tmp[230] - 1.0*p[3]*xB_tmp[228];
xBdot_tmp[232] = p[4]*xB_tmp[232] - 0.45*p[2]*xB_tmp[229] - 0.55*p[2]*xB_tmp[228];
...
xBdot_tmp[235] = p[3]*xB_tmp[235] - 0.55*p[2]*xB_tmp[231] - 1.0*p[3]*xB_tmp[232] - 0.9*p[2]*xB_tmp[230];
xBdot_tmp[236] = - 1.1*p[2]*xB_tmp[223] - 0.45*p[2]*xB_tmp[231] - 1.0*p[2]*xB_tmp[235];
xBdot_tmp[237] = xB_tmp[237]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[244] - 1.0*p[3]*xB_tmp[243] - 1.0*p[2]*xB_tmp[235];
...
xBdot_tmp[243] = xB_tmp[243]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[232] - 1.0*p[1]*xB_tmp[212];
xBdot_tmp[244] = xB_tmp[244]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[237] - 1.0*p[3]*xB_tmp[212];
xBdot_tmp[245] = 0.0002*xB_tmp[245] - 1.0*p[2]*xB_tmp[248] - 0.0002*xB_tmp[276];
xBdot_tmp[246] = (p[4] + 0.0002)*xB_tmp[246] - 0.0002*xB_tmp[247];
xBdot_tmp[247] = xB_tmp[247]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[278];
xBdot_tmp[248] = (p[3] + 0.0002)*xB_tmp[248] - 1.0*p[3]*xB_tmp[246] - 0.0002*xB_tmp[279];
...
xBdot_tmp[257] = p[1]*xB_tmp[257] - 1.0*p[2]*xB_tmp[271] - 1.0*p[2]*xB_tmp[272] - 1.0*p[1]*xB_tmp[276];
xBdot_tmp[258] = -1.0*p[2]*xB_tmp[266];
xBdot_tmp[259] = p[4]*xB_tmp[259] - 1.0*p[4]*xB_tmp[260];
xBdot_tmp[260] = 2.0*p[4]*xB_tmp[260];
xBdot_tmp[261] = - 1.0*p[2]*xB_tmp[262] - 1.0*p[2]*xB_tmp[265];
xBdot_tmp[262] = p[3]*xB_tmp[262] - 1.0*p[3]*xB_tmp[260] - 1.0*p[3]*xB_tmp[259] + p[3]*xB_tmp[264] - 1.0*p[3]*xB_tmp[265];
xBdot_tmp[263] = p[4]*xB_tmp[263] - 1.0*p[2]*xB_tmp[264];
xBdot_tmp[264] = xB_tmp[264]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[260];
xBdot_tmp[265] = 2.0*p[3]*xB_tmp[265] - 1.0*p[3]*xB_tmp[264];
xBdot_tmp[266] = p[3]*xB_tmp[266] - 2.0*p[2]*xB_tmp[265] - 1.0*p[3]*xB_tmp[263];
xBdot_tmp[267] = p[4]*xB_tmp[267] - 0.45*p[2]*xB_tmp[264] - 0.55*p[2]*xB_tmp[263];
...
xBdot_tmp[270] = p[3]*xB_tmp[270] - 0.55*p[2]*xB_tmp[266] - 1.0*p[3]*xB_tmp[267] - 0.9*p[2]*xB_tmp[265];
xBdot_tmp[271] = - 1.1*p[2]*xB_tmp[258] - 0.45*p[2]*xB_tmp[266] - 1.0*p[2]*xB_tmp[270];
xBdot_tmp[272] = xB_tmp[272]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[279] - 1.0*p[3]*xB_tmp[278] - 1.0*p[2]*xB_tmp[270];
...
xBdot_tmp[278] = xB_tmp[278]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[267] - 1.0*p[1]*xB_tmp[247];
xBdot_tmp[279] = xB_tmp[279]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[272] - 1.0*p[3]*xB_tmp[247];
xBdot_tmp[280] = 0.0002*xB_tmp[280] - 1.0*p[2]*xB_tmp[283] - 0.0002*xB_tmp[311];
xBdot_tmp[281] = (p[4] + 0.0002)*xB_tmp[281] - 0.0002*xB_tmp[282];
xBdot_tmp[282] = xB_tmp[282]*(p[0] + p[4]) - 1.0*p[0]*xB_tmp[313];
xBdot_tmp[283] = (p[3] + 0.0002)*xB_tmp[283] - 1.0*p[3]*xB_tmp[281] - 0.0002*xB_tmp[314];
...
xBdot_tmp[292] = p[1]*xB_tmp[292] - 1.0*p[2]*xB_tmp[306] - 1.0*p[2]*xB_tmp[307] - 1.0*p[1]*xB_tmp[311];
xBdot_tmp[293] = -1.0*p[2]*xB_tmp[301];
xBdot_tmp[294] = p[4]*xB_tmp[294] - 1.0*p[4]*xB_tmp[295];
xBdot_tmp[295] = 2.0*p[4]*xB_tmp[295];
xBdot_tmp[296] = - 1.0*p[2]*xB_tmp[297] - 1.0*p[2]*xB_tmp[300];
xBdot_tmp[297] = p[3]*xB_tmp[297] - 1.0*p[3]*xB_tmp[295] - 1.0*p[3]*xB_tmp[294] + p[3]*xB_tmp[299] - 1.0*p[3]*xB_tmp[300];
xBdot_tmp[298] = p[4]*xB_tmp[298] - 1.0*p[2]*xB_tmp[299];
xBdot_tmp[299] = xB_tmp[299]*(p[3] + p[4]) - 2.0*p[3]*xB_tmp[295];
xBdot_tmp[300] = 2.0*p[3]*xB_tmp[300] - 1.0*p[3]*xB_tmp[299];
xBdot_tmp[301] = p[3]*xB_tmp[301] - 2.0*p[2]*xB_tmp[300] - 1.0*p[3]*xB_tmp[298];
xBdot_tmp[302] = p[4]*xB_tmp[302] - 0.45*p[2]*xB_tmp[299] - 0.55*p[2]*xB_tmp[298];
...
xBdot_tmp[305] = p[3]*xB_tmp[305] - 0.55*p[2]*xB_tmp[301] - 1.0*p[3]*xB_tmp[302] - 0.9*p[2]*xB_tmp[300];
xBdot_tmp[306] = - 1.1*p[2]*xB_tmp[293] - 0.45*p[2]*xB_tmp[301] - 1.0*p[2]*xB_tmp[305];
xBdot_tmp[307] = xB_tmp[307]*(p[1] + p[3]) - 1.0*p[1]*xB_tmp[314] - 1.0*p[3]*xB_tmp[313] - 1.0*p[2]*xB_tmp[305];
...
xBdot_tmp[313] = xB_tmp[313]*(p[1] + p[4]) - 1.0*p[2]*xB_tmp[302] - 1.0*p[1]*xB_tmp[282];
xBdot_tmp[314] = xB_tmp[314]*(p[0] + p[3]) - 1.0*p[0]*xB_tmp[307] - 1.0*p[3]*xB_tmp[282];
 ...
 int xQB__sA_sPB_3o_2B_S_atS__T_atS__B_atS(realtype t, N_Vector x, N_Vector xB, N_Vector qBdot, void *user_data)
{
  int iyp;
  int ip;
  UserData data = (UserData) user_data;
...
qBdot_tmp[8+ip*ny] = x_tmp[7]*xB_tmp[287] - 1.0*x_tmp[7]*xB_tmp[285] + x_tmp[12]*xB_tmp[292] - 1.0*x_tmp[33]*xB_tmp[282] - 1.0*x_tmp[28]*xB_tmp[289] - 1.0*x_tmp[12]*xB_tmp[311] + x_tmp[27]*xB_tmp[307] + x_tmp[28]*xB_tmp[308] - 1.0*x_tmp[27]*xB_tmp[314] - 1.0*x_tmp[32]*xB_tmp[310] + x_tmp[32]*xB_tmp[312] + x_tmp[33]*xB_tmp[313] + (2.0*x_tmp[10] - 1.0*x_tmp[28])*xB_tmp[290] + xB_tmp[291]*(x_tmp[11] - 1.0*x_tmp[10] + x_tmp[28]) - 1.0*(2.0*x_tmp[11] + x_tmp[28])*xB_tmp[288];
  ...
  case 2: {
qBdot_tmp[0+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[0] - 1.0*x_tmp[7]*xB_tmp[29] - 0.55*x_tmp[23]*xB_tmp[16] - 0.55*x_tmp[22]*xB_tmp[18] - 1.0*x_tmp[11]*xB_tmp[30] - 1.0*x_tmp[10]*xB_tmp[32] - 0.55*x_tmp[32]*xB_tmp[12] - 1.0*x_tmp[28]*xB_tmp[23] - 1.0*x_tmp[33]*xB_tmp[22] - 0.55*x_tmp[30]*xB_tmp[31] - 1.0*xB_tmp[3]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[17]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[19]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[27]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[34]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[20]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[13] - 1.0*xB_tmp[21]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[24] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[26] - 1.0*xB_tmp[25]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[1+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[35] - 1.0*x_tmp[7]*xB_tmp[64] - 0.55*x_tmp[23]*xB_tmp[51] - 0.55*x_tmp[22]*xB_tmp[53] - 1.0*x_tmp[11]*xB_tmp[65] - 1.0*x_tmp[10]*xB_tmp[67] - 0.55*x_tmp[32]*xB_tmp[47] - 1.0*x_tmp[28]*xB_tmp[58] - 1.0*x_tmp[33]*xB_tmp[57] - 0.55*x_tmp[30]*xB_tmp[66] - 1.0*xB_tmp[38]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[52]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[54]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[62]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[69]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[55]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[48] - 1.0*xB_tmp[56]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[59] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[61] - 1.0*xB_tmp[60]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[2+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[70] - 1.0*x_tmp[7]*xB_tmp[99] - 0.55*x_tmp[23]*xB_tmp[86] - 0.55*x_tmp[22]*xB_tmp[88] - 1.0*x_tmp[11]*xB_tmp[100] - 1.0*x_tmp[10]*xB_tmp[102] - 0.55*x_tmp[32]*xB_tmp[82] - 1.0*x_tmp[28]*xB_tmp[93] - 1.0*x_tmp[33]*xB_tmp[92] - 0.55*x_tmp[30]*xB_tmp[101] - 1.0*xB_tmp[73]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[87]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[89]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[97]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[104]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[90]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[83] - 1.0*xB_tmp[91]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[94] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[96] - 1.0*xB_tmp[95]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[3+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[105] - 1.0*x_tmp[7]*xB_tmp[134] - 0.55*x_tmp[23]*xB_tmp[121] - 0.55*x_tmp[22]*xB_tmp[123] - 1.0*x_tmp[11]*xB_tmp[135] - 1.0*x_tmp[10]*xB_tmp[137] - 0.55*x_tmp[32]*xB_tmp[117] - 1.0*x_tmp[28]*xB_tmp[128] - 1.0*x_tmp[33]*xB_tmp[127] - 0.55*x_tmp[30]*xB_tmp[136] - 1.0*xB_tmp[108]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[122]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[124]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[132]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[139]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[125]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[118] - 1.0*xB_tmp[126]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[129] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[131] - 1.0*xB_tmp[130]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[4+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[140] - 1.0*x_tmp[7]*xB_tmp[169] - 0.55*x_tmp[23]*xB_tmp[156] - 0.55*x_tmp[22]*xB_tmp[158] - 1.0*x_tmp[11]*xB_tmp[170] - 1.0*x_tmp[10]*xB_tmp[172] - 0.55*x_tmp[32]*xB_tmp[152] - 1.0*x_tmp[28]*xB_tmp[163] - 1.0*x_tmp[33]*xB_tmp[162] - 0.55*x_tmp[30]*xB_tmp[171] - 1.0*xB_tmp[143]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[157]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[159]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[167]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[174]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[160]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[153] - 1.0*xB_tmp[161]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[164] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[166] - 1.0*xB_tmp[165]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[5+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[175] - 1.0*x_tmp[7]*xB_tmp[204] - 0.55*x_tmp[23]*xB_tmp[191] - 0.55*x_tmp[22]*xB_tmp[193] - 1.0*x_tmp[11]*xB_tmp[205] - 1.0*x_tmp[10]*xB_tmp[207] - 0.55*x_tmp[32]*xB_tmp[187] - 1.0*x_tmp[28]*xB_tmp[198] - 1.0*x_tmp[33]*xB_tmp[197] - 0.55*x_tmp[30]*xB_tmp[206] - 1.0*xB_tmp[178]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[192]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[194]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[202]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[209]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[195]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[188] - 1.0*xB_tmp[196]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[199] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[201] - 1.0*xB_tmp[200]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[6+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[210] - 1.0*x_tmp[7]*xB_tmp[239] - 0.55*x_tmp[23]*xB_tmp[226] - 0.55*x_tmp[22]*xB_tmp[228] - 1.0*x_tmp[11]*xB_tmp[240] - 1.0*x_tmp[10]*xB_tmp[242] - 0.55*x_tmp[32]*xB_tmp[222] - 1.0*x_tmp[28]*xB_tmp[233] - 1.0*x_tmp[33]*xB_tmp[232] - 0.55*x_tmp[30]*xB_tmp[241] - 1.0*xB_tmp[213]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[227]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[229]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[237]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[244]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[230]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[223] - 1.0*xB_tmp[231]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[234] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[236] - 1.0*xB_tmp[235]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[7+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[245] - 1.0*x_tmp[7]*xB_tmp[274] - 0.55*x_tmp[23]*xB_tmp[261] - 0.55*x_tmp[22]*xB_tmp[263] - 1.0*x_tmp[11]*xB_tmp[275] - 1.0*x_tmp[10]*xB_tmp[277] - 0.55*x_tmp[32]*xB_tmp[257] - 1.0*x_tmp[28]*xB_tmp[268] - 1.0*x_tmp[33]*xB_tmp[267] - 0.55*x_tmp[30]*xB_tmp[276] - 1.0*xB_tmp[248]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[262]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[264]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[272]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[279]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[265]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[258] - 1.0*xB_tmp[266]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[269] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[271] - 1.0*xB_tmp[270]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
qBdot_tmp[8+ip*ny] = - 0.55*x_tmp[29]*xB_tmp[280] - 1.0*x_tmp[7]*xB_tmp[309] - 0.55*x_tmp[23]*xB_tmp[296] - 0.55*x_tmp[22]*xB_tmp[298] - 1.0*x_tmp[11]*xB_tmp[310] - 1.0*x_tmp[10]*xB_tmp[312] - 0.55*x_tmp[32]*xB_tmp[292] - 1.0*x_tmp[28]*xB_tmp[303] - 1.0*x_tmp[33]*xB_tmp[302] - 0.55*x_tmp[30]*xB_tmp[311] - 1.0*xB_tmp[283]*(x_tmp[0] + 0.45*x_tmp[29]) - 1.0*xB_tmp[297]*(x_tmp[16] + 0.45*x_tmp[23]) - 1.0*xB_tmp[299]*(x_tmp[18] + 0.45*x_tmp[22]) - 1.0*xB_tmp[307]*(x_tmp[12] + 0.45*x_tmp[32]) - 1.0*xB_tmp[314]*(0.45*x_tmp[30] + x_tmp[31]) - 1.0*xB_tmp[300]*(x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25]) - 1.0*(0.55*x_tmp[23] + 1.1*x_tmp[26])*xB_tmp[293] - 1.0*xB_tmp[301]*(x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26]) - 1.0*(x_tmp[28] + 2.0*x_tmp[32])*xB_tmp[304] - 1.0*(x_tmp[12] + 0.55*x_tmp[24])*xB_tmp[306] - 1.0*xB_tmp[305]*(0.45*x_tmp[24] + x_tmp[26] + x_tmp[27]);
...
qBdot_tmp[8+ip*ny] = x_tmp[1]*xB_tmp[281] + x_tmp[2]*xB_tmp[282] + x_tmp[14]*xB_tmp[294] + x_tmp[18]*xB_tmp[298] + x_tmp[19]*xB_tmp[299] + x_tmp[22]*xB_tmp[302] + x_tmp[33]*xB_tmp[313] - 1.0*(x_tmp[14] - 2.0*x_tmp[15])*xB_tmp[295];
 ...
 void x0__sA_sPB_3o_2B_S_atS__T_atS__B_atS(N_Vector x0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
...
x0_tmp[2] = k[19]*k[54];
x0_tmp[3] = k[12]*k[47];
x0_tmp[4] = (k[7] - 1.0)*((pow(p[5],2)) - 1.0*p[5]) + k[7]*k[42];
x0_tmp[5] = k[8]*k[43] + (k[8] - 1.0)*p[5]*p[6];
x0_tmp[6] = k[0]*k[35] - 1.0*(k[0] - 1.0)*p[5];
x0_tmp[7] = k[9]*k[44] - 1.0*(k[9] - 1.0)*p[5]*(p[5] + p[6] - 1.0);
x0_tmp[8] = (k[14] - 1.0)*((pow(p[6],2)) - 1.0*p[6]) + k[14]*k[49];
x0_tmp[9] = k[1]*k[36] - 1.0*(k[1] - 1.0)*p[6];
x0_tmp[10] = k[20]*k[55] + (k[20] - 1.0)*(p[5] + p[6])*(p[5] + p[6] - 1.0);
x0_tmp[11] = k[15]*k[50] - 1.0*(k[15] - 1.0)*p[6]*(p[5] + p[6] - 1.0);
x0_tmp[12] = k[22]*k[57];
x0_tmp[13] = k[29]*k[64];
x0_tmp[14] = k[6]*k[41];
x0_tmp[15] = k[34]*k[69];
...
x0_tmp[26] = k[26]*k[61];
x0_tmp[27] = k[23]*k[58];
x0_tmp[28] = (k[2] - 1.0)*(p[5] + p[6] - 1.0) + k[2]*k[37];
x0_tmp[29] = k[10]*k[45];
x0_tmp[30] = k[16]*k[51];
x0_tmp[31] = k[17]*k[52];
x0_tmp[32] = k[21]*k[56];
...
x0_tmp[34] = k[18]*k[53];
 ...
 int Jv__sA_sPB_3o_2B_S_atS__T_atS__B_atS(N_Vector v, N_Vector Jv, realtype t,
...
Jv_tmp[1] = p[3]*v_tmp[3] - 1.0*(p[4] + 0.0002)*v_tmp[1];
Jv_tmp[2] = p[1]*v_tmp[33] + p[3]*v_tmp[34] - 1.0*v_tmp[2]*(p[0] + p[4]) + 0.0002*v_tmp[1];
Jv_tmp[3] = p[2]*v_tmp[0] + 0.45*p[2]*v_tmp[29] - 1.0*(p[3] + 0.0002)*v_tmp[3];
...
Jv_tmp[12] = p[0]*v_tmp[31] - 1.0*p[1]*v_tmp[12] + 0.55*p[2]*v_tmp[32];
Jv_tmp[13] = 0.55*p[2]*v_tmp[23] + 1.1*p[2]*v_tmp[26];
Jv_tmp[14] = p[3]*v_tmp[17] - 1.0*p[4]*v_tmp[14];
Jv_tmp[15] = p[4]*v_tmp[14] - 2.0*p[4]*v_tmp[15] + p[3]*v_tmp[17] + 2.0*p[3]*v_tmp[19];
Jv_tmp[16] = 0.55*p[2]*v_tmp[23];
Jv_tmp[17] = p[2]*v_tmp[16] - 1.0*p[3]*v_tmp[17] + 0.45*p[2]*v_tmp[23];
Jv_tmp[18] = 0.55*p[2]*v_tmp[22] - 1.0*p[4]*v_tmp[18] + p[3]*v_tmp[21];
Jv_tmp[19] = p[2]*v_tmp[18] - 1.0*p[3]*v_tmp[17] + p[3]*v_tmp[20] + 0.45*p[2]*v_tmp[22] - 1.0*v_tmp[19]*(p[3] + p[4]);
Jv_tmp[20] = p[2]*v_tmp[16] + p[3]*v_tmp[17] + 2.0*p[2]*v_tmp[21] - 2.0*p[3]*v_tmp[20] + 0.45*p[2]*v_tmp[23] + 0.9*p[2]*v_tmp[25];
Jv_tmp[21] = p[2]*v_tmp[13] - 1.0*p[3]*v_tmp[21] + 0.55*p[2]*v_tmp[25] + 0.45*p[2]*v_tmp[26];
Jv_tmp[22] = p[3]*v_tmp[25] - 1.0*p[4]*v_tmp[22] + p[2]*v_tmp[33];
Jv_tmp[23] = p[2]*v_tmp[28];
Jv_tmp[24] = p[2]*v_tmp[28] + 2.0*p[2]*v_tmp[32];
Jv_tmp[25] = 0.45*p[2]*v_tmp[24] + p[2]*v_tmp[26] - 1.0*p[3]*v_tmp[25] + p[2]*v_tmp[27];
Jv_tmp[26] = p[2]*v_tmp[12] + 0.55*p[2]*v_tmp[24];
Jv_tmp[27] = p[2]*v_tmp[12] + p[0]*v_tmp[34] + 0.45*p[2]*v_tmp[32] - 1.0*v_tmp[27]*(p[1] + p[3]);
...
Jv_tmp[33] = p[0]*v_tmp[2] + p[3]*v_tmp[27] - 1.0*v_tmp[33]*(p[1] + p[4]);
Jv_tmp[34] = p[1]*v_tmp[27] + 0.45*p[2]*v_tmp[30] + p[2]*v_tmp[31] - 1.0*v_tmp[34]*(p[0] + p[3]) + 0.0002*v_tmp[3];
 ...
 int JvB__sA_sPB_3o_2B_S_atS__T_atS__B_atS(N_Vector vB, N_Vector JvB, realtype t,
...
JvB_tmp[1] = (p[4] + 0.0002)*vB_tmp[1] - 0.0002*vB_tmp[2];
JvB_tmp[2] = vB_tmp[2]*(p[0] + p[4]) - 1.0*p[0]*vB_tmp[33];
JvB_tmp[3] = (p[3] + 0.0002)*vB_tmp[3] - 1.0*p[3]*vB_tmp[1] - 0.0002*vB_tmp[34];
...
JvB_tmp[12] = p[1]*vB_tmp[12] - 1.0*p[2]*vB_tmp[26] - 1.0*p[2]*vB_tmp[27] - 1.0*p[1]*vB_tmp[31];
JvB_tmp[13] = -1.0*p[2]*vB_tmp[21];
JvB_tmp[14] = p[4]*vB_tmp[14] - 1.0*p[4]*vB_tmp[15];
JvB_tmp[15] = 2.0*p[4]*vB_tmp[15];
JvB_tmp[16] = - 1.0*p[2]*vB_tmp[17] - 1.0*p[2]*vB_tmp[20];
JvB_tmp[17] = p[3]*vB_tmp[17] - 1.0*p[3]*vB_tmp[15] - 1.0*p[3]*vB_tmp[14] + p[3]*vB_tmp[19] - 1.0*p[3]*vB_tmp[20];
JvB_tmp[18] = p[4]*vB_tmp[18] - 1.0*p[2]*vB_tmp[19];
JvB_tmp[19] = vB_tmp[19]*(p[3] + p[4]) - 2.0*p[3]*vB_tmp[15];
JvB_tmp[20] = 2.0*p[3]*vB_tmp[20] - 1.0*p[3]*vB_tmp[19];
JvB_tmp[21] = p[3]*vB_tmp[21] - 2.0*p[2]*vB_tmp[20] - 1.0*p[3]*vB_tmp[18];
JvB_tmp[22] = p[4]*vB_tmp[22] - 0.45*p[2]*vB_tmp[19] - 0.55*p[2]*vB_tmp[18];
...
JvB_tmp[25] = p[3]*vB_tmp[25] - 0.55*p[2]*vB_tmp[21] - 1.0*p[3]*vB_tmp[22] - 0.9*p[2]*vB_tmp[20];
JvB_tmp[26] = - 1.1*p[2]*vB_tmp[13] - 0.45*p[2]*vB_tmp[21] - 1.0*p[2]*vB_tmp[25];
JvB_tmp[27] = vB_tmp[27]*(p[1] + p[3]) - 1.0*p[1]*vB_tmp[34] - 1.0*p[3]*vB_tmp[33] - 1.0*p[2]*vB_tmp[25];
...
JvB_tmp[33] = vB_tmp[33]*(p[1] + p[4]) - 1.0*p[2]*vB_tmp[22] - 1.0*p[1]*vB_tmp[2];
JvB_tmp[34] = vB_tmp[34]*(p[0] + p[3]) - 1.0*p[0]*vB_tmp[27] - 1.0*p[3]*vB_tmp[2];
 ...
 int JBand__sA_sPB_3o_2B_S_atS__T_atS__B_atS(long int N, long int mupper, long int mlower,   realtype t, N_Vector x, N_Vector xdot,
  	DlsMat J, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  return(J__sA_sPB_3o_2B_S_atS__T_atS__B_atS(N,t,x,xdot,J,user_data,tmp1,tmp2,tmp3));
}


 int J__sA_sPB_3o_2B_S_atS__T_atS__B_atS(long int N, realtype t, N_Vector x,
...
J->data[3] = p[2];
J->data[31] = 0.0002;
J->data[36] = - 1.0*p[4] - 0.0002;
J->data[37] = 0.0002;
J->data[72] = - 1.0*p[0] - 1.0*p[4];
J->data[103] = p[0];
J->data[106] = p[3];
J->data[108] = - 1.0*p[3] - 0.0002;
J->data[139] = 0.0002;
J->data[144] = -0.0004;
J->data[145] = 0.0002;
...
J->data[1157] = p[1];
J->data[1177] = p[2];
J->data[1188] = - 1.0*p[1] - 1.0*p[4];
J->data[1192] = p[3];
J->data[1217] = p[0];
J->data[1224] = - 1.0*p[0] - 1.0*p[3];
 ...
 int JSparse__sA_sPB_3o_2B_S_atS__T_atS__B_atS(realtype t, N_Vector x,
...
J->data[1] = p[2];
J->data[2] = 0.0002;
J->data[3] = - 1.0*p[4] - 0.0002;
J->data[4] = 0.0002;
J->data[5] = - 1.0*p[0] - 1.0*p[4];
J->data[6] = p[0];
J->data[7] = p[3];
J->data[8] = - 1.0*p[3] - 0.0002;
J->data[9] = 0.0002;
J->data[10] = -0.0004;
J->data[11] = 0.0002;
...
J->data[105] = p[1];
J->data[106] = p[2];
J->data[107] = - 1.0*p[1] - 1.0*p[4];
J->data[108] = p[3];
J->data[109] = p[0];
J->data[110] = - 1.0*p[0] - 1.0*p[3];
  return(0);
}


 int JBBand__sA_sPB_3o_2B_S_atS__T_atS__B_atS(long int NeqB, long int mupper, long int mlower,   realtype t, N_Vector x, N_Vector xB,
  	N_Vector xdotB, DlsMat J, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  return(JB__sA_sPB_3o_2B_S_atS__T_atS__B_atS(NeqB,t,x,xB,xdotB,J,user_data,tmp1,tmp2,tmp3));
}
 int JB__sA_sPB_3o_2B_S_atS__T_atS__B_atS(long int N, realtype t, N_Vector x,
...
JB->data[1224] = p[0] + p[3];
 ...
 int JSparseB__sA_sPB_3o_2B_S_atS__T_atS__B_atS(realtype t, N_Vector x,
  	...
  	N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B)
{
 ...
 int sx__sA_sPB_3o_2B_S_atS__T_atS__B_atS(int Ns, realtype t, N_Vector x, N_Vector xdot,
...
sxdot_tmp[1] = p[3]*sx_tmp[3] - 1.0*(p[4] + 0.0002)*sx_tmp[1];
sxdot_tmp[2] = p[1]*sx_tmp[33] + p[3]*sx_tmp[34] - 1.0*sx_tmp[2]*(p[0] + p[4]) + 0.0002*sx_tmp[1] - 1.0*x_tmp[2];
sxdot_tmp[3] = p[2]*sx_tmp[0] + 0.45*p[2]*sx_tmp[29] - 1.0*(p[3] + 0.0002)*sx_tmp[3];
...
sxdot_tmp[12] = p[0]*sx_tmp[31] - 1.0*p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[32] + x_tmp[31];
sxdot_tmp[13] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26];
sxdot_tmp[14] = p[3]*sx_tmp[17] - 1.0*p[4]*sx_tmp[14];
sxdot_tmp[15] = p[4]*sx_tmp[14] - 2.0*p[4]*sx_tmp[15] + p[3]*sx_tmp[17] + 2.0*p[3]*sx_tmp[19];
sxdot_tmp[16] = 0.55*p[2]*sx_tmp[23];
sxdot_tmp[17] = p[2]*sx_tmp[16] - 1.0*p[3]*sx_tmp[17] + 0.45*p[2]*sx_tmp[23];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[18] + p[3]*sx_tmp[21];
sxdot_tmp[19] = p[2]*sx_tmp[18] - 1.0*p[3]*sx_tmp[17] + p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[22] - 1.0*sx_tmp[19]*(p[3] + p[4]);
sxdot_tmp[20] = p[2]*sx_tmp[16] + p[3]*sx_tmp[17] + 2.0*p[2]*sx_tmp[21] - 2.0*p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[23] + 0.9*p[2]*sx_tmp[25];
sxdot_tmp[21] = p[2]*sx_tmp[13] - 1.0*p[3]*sx_tmp[21] + 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26];
sxdot_tmp[22] = p[3]*sx_tmp[25] - 1.0*p[4]*sx_tmp[22] + p[2]*sx_tmp[33];
sxdot_tmp[23] = p[2]*sx_tmp[28];
sxdot_tmp[24] = p[2]*sx_tmp[28] + 2.0*p[2]*sx_tmp[32];
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[26] - 1.0*p[3]*sx_tmp[25] + p[2]*sx_tmp[27];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24];
sxdot_tmp[27] = p[2]*sx_tmp[12] + p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[3]) + x_tmp[34];
...
sxdot_tmp[33] = p[0]*sx_tmp[2] + p[3]*sx_tmp[27] - 1.0*sx_tmp[33]*(p[1] + p[4]) + x_tmp[2];
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] + p[2]*sx_tmp[31] - 1.0*sx_tmp[34]*(p[0] + p[3]) + 0.0002*sx_tmp[3] - 1.0*x_tmp[34];
...
sxdot_tmp[0] = 0.55*p[2]*sx_tmp[29] - 0.0002*sx_tmp[0];
sxdot_tmp[1] = p[3]*sx_tmp[3] - 1.0*(p[4] + 0.0002)*sx_tmp[1];
sxdot_tmp[2] = p[1]*sx_tmp[33] + p[3]*sx_tmp[34] - 1.0*sx_tmp[2]*(p[0] + p[4]) + 0.0002*sx_tmp[1] + x_tmp[33];
sxdot_tmp[3] = p[2]*sx_tmp[0] + 0.45*p[2]*sx_tmp[29] - 1.0*(p[3] + 0.0002)*sx_tmp[3];
sxdot_tmp[4] = 0.0002*sx_tmp[6] - 0.0004*sx_tmp[4];
...
sxdot_tmp[12] = p[0]*sx_tmp[31] - 1.0*p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[32] - 1.0*x_tmp[12];
sxdot_tmp[13] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26];
sxdot_tmp[14] = p[3]*sx_tmp[17] - 1.0*p[4]*sx_tmp[14];
sxdot_tmp[15] = p[4]*sx_tmp[14] - 2.0*p[4]*sx_tmp[15] + p[3]*sx_tmp[17] + 2.0*p[3]*sx_tmp[19];
sxdot_tmp[16] = 0.55*p[2]*sx_tmp[23];
...
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[26] - 1.0*p[3]*sx_tmp[25] + p[2]*sx_tmp[27];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24];
sxdot_tmp[27] = p[2]*sx_tmp[12] + p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[3]) - 1.0*x_tmp[27];
...
sxdot_tmp[33] = p[0]*sx_tmp[2] + p[3]*sx_tmp[27] - 1.0*sx_tmp[33]*(p[1] + p[4]) - 1.0*x_tmp[33];
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] + p[2]*sx_tmp[31] - 1.0*sx_tmp[34]*(p[0] + p[3]) + 0.0002*sx_tmp[3] + x_tmp[27];
...
sxdot_tmp[1] = p[3]*sx_tmp[3] - 1.0*(p[4] + 0.0002)*sx_tmp[1];
sxdot_tmp[2] = p[1]*sx_tmp[33] + p[3]*sx_tmp[34] - 1.0*sx_tmp[2]*(p[0] + p[4]) + 0.0002*sx_tmp[1];
sxdot_tmp[3] = p[2]*sx_tmp[0] + 0.45*p[2]*sx_tmp[29] - 1.0*(p[3] + 0.0002)*sx_tmp[3] + x_tmp[0] + 0.45*x_tmp[29];
sxdot_tmp[4] = 0.0002*sx_tmp[6] - 0.0004*sx_tmp[4];
...
sxdot_tmp[12] = p[0]*sx_tmp[31] - 1.0*p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[32] + 0.55*x_tmp[32];
...
sxdot_tmp[17] = p[2]*sx_tmp[16] - 1.0*p[3]*sx_tmp[17] + 0.45*p[2]*sx_tmp[23] + x_tmp[16] + 0.45*x_tmp[23];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[18] + p[3]*sx_tmp[21] + 0.55*x_tmp[22];
sxdot_tmp[19] = p[2]*sx_tmp[18] - 1.0*p[3]*sx_tmp[17] + p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[22] - 1.0*sx_tmp[19]*(p[3] + p[4]) + x_tmp[18] + 0.45*x_tmp[22];
sxdot_tmp[20] = p[2]*sx_tmp[16] + p[3]*sx_tmp[17] + 2.0*p[2]*sx_tmp[21] - 2.0*p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[23] + 0.9*p[2]*sx_tmp[25] + x_tmp[16] + 2.0*x_tmp[21] + 0.45*x_tmp[23] + 0.9*x_tmp[25];
sxdot_tmp[21] = p[2]*sx_tmp[13] - 1.0*p[3]*sx_tmp[21] + 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26] + x_tmp[13] + 0.55*x_tmp[25] + 0.45*x_tmp[26];
sxdot_tmp[22] = p[3]*sx_tmp[25] - 1.0*p[4]*sx_tmp[22] + p[2]*sx_tmp[33] + x_tmp[33];
sxdot_tmp[23] = p[2]*sx_tmp[28] + x_tmp[28];
sxdot_tmp[24] = p[2]*sx_tmp[28] + 2.0*p[2]*sx_tmp[32] + x_tmp[28] + 2.0*x_tmp[32];
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[26] - 1.0*p[3]*sx_tmp[25] + p[2]*sx_tmp[27] + 0.45*x_tmp[24] + x_tmp[26] + x_tmp[27];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24] + x_tmp[12] + 0.55*x_tmp[24];
sxdot_tmp[27] = p[2]*sx_tmp[12] + p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[3]) + x_tmp[12] + 0.45*x_tmp[32];
...
sxdot_tmp[33] = p[0]*sx_tmp[2] + p[3]*sx_tmp[27] - 1.0*sx_tmp[33]*(p[1] + p[4]);
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] + p[2]*sx_tmp[31] - 1.0*sx_tmp[34]*(p[0] + p[3]) + 0.0002*sx_tmp[3] + 0.45*x_tmp[30] + x_tmp[31];

  } break;

  case 3: {
sxdot_tmp[0] = 0.55*p[2]*sx_tmp[29] - 0.0002*sx_tmp[0];
sxdot_tmp[1] = p[3]*sx_tmp[3] - 1.0*(p[4] + 0.0002)*sx_tmp[1] + x_tmp[3];
sxdot_tmp[2] = p[1]*sx_tmp[33] + p[3]*sx_tmp[34] - 1.0*sx_tmp[2]*(p[0] + p[4]) + 0.0002*sx_tmp[1] + x_tmp[34];
sxdot_tmp[3] = p[2]*sx_tmp[0] + 0.45*p[2]*sx_tmp[29] - 1.0*(p[3] + 0.0002)*sx_tmp[3] - 1.0*x_tmp[3];
sxdot_tmp[4] = 0.0002*sx_tmp[6] - 0.0004*sx_tmp[4];
sxdot_tmp[5] = p[1]*sx_tmp[7] - 1.0*(p[0] + 0.0002)*sx_tmp[5] + 0.0002*sx_tmp[4] - 0.0002*sx_tmp[6];
sxdot_tmp[6] = -0.0002*sx_tmp[6];
sxdot_tmp[7] = p[0]*sx_tmp[5] - 1.0*(p[1] + 0.0002)*sx_tmp[7];
...
sxdot_tmp[10] = p[0]*sx_tmp[9] + 2.0*p[0]*sx_tmp[11] - 2.0*p[1]*sx_tmp[10] + p[1]*sx_tmp[28];
sxdot_tmp[11] = p[0]*sx_tmp[8] - 1.0*p[0]*sx_tmp[9] + p[1]*sx_tmp[10] - 1.0*p[1]*sx_tmp[28] - 1.0*sx_tmp[11]*(p[0] + p[1]) + 0.0002*sx_tmp[7];
sxdot_tmp[12] = p[0]*sx_tmp[31] - 1.0*p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[32];
sxdot_tmp[13] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26];
sxdot_tmp[14] = p[3]*sx_tmp[17] - 1.0*p[4]*sx_tmp[14] + x_tmp[17];
sxdot_tmp[15] = p[4]*sx_tmp[14] - 2.0*p[4]*sx_tmp[15] + p[3]*sx_tmp[17] + 2.0*p[3]*sx_tmp[19] + x_tmp[17] + 2.0*x_tmp[19];
sxdot_tmp[16] = 0.55*p[2]*sx_tmp[23];
sxdot_tmp[17] = p[2]*sx_tmp[16] - 1.0*p[3]*sx_tmp[17] + 0.45*p[2]*sx_tmp[23] - 1.0*x_tmp[17];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[18] + p[3]*sx_tmp[21] + x_tmp[21];
sxdot_tmp[19] = p[2]*sx_tmp[18] - 1.0*p[3]*sx_tmp[17] + p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[22] - 1.0*sx_tmp[19]*(p[3] + p[4]) - 1.0*x_tmp[17] - 1.0*x_tmp[19] + x_tmp[20];
sxdot_tmp[20] = p[2]*sx_tmp[16] + p[3]*sx_tmp[17] + 2.0*p[2]*sx_tmp[21] - 2.0*p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[23] + 0.9*p[2]*sx_tmp[25] + x_tmp[17] - 2.0*x_tmp[20];
sxdot_tmp[21] = p[2]*sx_tmp[13] - 1.0*p[3]*sx_tmp[21] + 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26] - 1.0*x_tmp[21];
sxdot_tmp[22] = p[3]*sx_tmp[25] - 1.0*p[4]*sx_tmp[22] + p[2]*sx_tmp[33] + x_tmp[25];
sxdot_tmp[23] = p[2]*sx_tmp[28];
sxdot_tmp[24] = p[2]*sx_tmp[28] + 2.0*p[2]*sx_tmp[32];
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[26] - 1.0*p[3]*sx_tmp[25] + p[2]*sx_tmp[27] - 1.0*x_tmp[25];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24];
sxdot_tmp[27] = p[2]*sx_tmp[12] + p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[3]) - 1.0*x_tmp[27];
sxdot_tmp[28] = p[0]*sx_tmp[9] - 1.0*p[1]*sx_tmp[28];
sxdot_tmp[29] = p[2]*sx_tmp[7] - 0.0002*sx_tmp[29];
...
sxdot_tmp[33] = p[0]*sx_tmp[2] + p[3]*sx_tmp[27] - 1.0*sx_tmp[33]*(p[1] + p[4]) + x_tmp[27];
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] + p[2]*sx_tmp[31] - 1.0*sx_tmp[34]*(p[0] + p[3]) + 0.0002*sx_tmp[3] - 1.0*x_tmp[34];
  ...
  case 4: {
sxdot_tmp[0] = 0.55*p[2]*sx_tmp[29] - 0.0002*sx_tmp[0];
sxdot_tmp[1] = p[3]*sx_tmp[3] - 1.0*(p[4] + 0.0002)*sx_tmp[1] - 1.0*x_tmp[1];
sxdot_tmp[2] = p[1]*sx_tmp[33] + p[3]*sx_tmp[34] - 1.0*sx_tmp[2]*(p[0] + p[4]) + 0.0002*sx_tmp[1] - 1.0*x_tmp[2];
sxdot_tmp[3] = p[2]*sx_tmp[0] + 0.45*p[2]*sx_tmp[29] - 1.0*(p[3] + 0.0002)*sx_tmp[3];
sxdot_tmp[4] = 0.0002*sx_tmp[6] - 0.0004*sx_tmp[4];
sxdot_tmp[5] = p[1]*sx_tmp[7] - 1.0*(p[0] + 0.0002)*sx_tmp[5] + 0.0002*sx_tmp[4] - 0.0002*sx_tmp[6];
...
sxdot_tmp[12] = p[0]*sx_tmp[31] - 1.0*p[1]*sx_tmp[12] + 0.55*p[2]*sx_tmp[32];
sxdot_tmp[13] = 0.55*p[2]*sx_tmp[23] + 1.1*p[2]*sx_tmp[26];
sxdot_tmp[14] = p[3]*sx_tmp[17] - 1.0*p[4]*sx_tmp[14] - 1.0*x_tmp[14];
sxdot_tmp[15] = p[4]*sx_tmp[14] - 2.0*p[4]*sx_tmp[15] + p[3]*sx_tmp[17] + 2.0*p[3]*sx_tmp[19] + x_tmp[14] - 2.0*x_tmp[15];
sxdot_tmp[16] = 0.55*p[2]*sx_tmp[23];
sxdot_tmp[17] = p[2]*sx_tmp[16] - 1.0*p[3]*sx_tmp[17] + 0.45*p[2]*sx_tmp[23];
sxdot_tmp[18] = 0.55*p[2]*sx_tmp[22] - 1.0*p[4]*sx_tmp[18] + p[3]*sx_tmp[21] - 1.0*x_tmp[18];
sxdot_tmp[19] = p[2]*sx_tmp[18] - 1.0*p[3]*sx_tmp[17] + p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[22] - 1.0*sx_tmp[19]*(p[3] + p[4]) - 1.0*x_tmp[19];
sxdot_tmp[20] = p[2]*sx_tmp[16] + p[3]*sx_tmp[17] + 2.0*p[2]*sx_tmp[21] - 2.0*p[3]*sx_tmp[20] + 0.45*p[2]*sx_tmp[23] + 0.9*p[2]*sx_tmp[25];
sxdot_tmp[21] = p[2]*sx_tmp[13] - 1.0*p[3]*sx_tmp[21] + 0.55*p[2]*sx_tmp[25] + 0.45*p[2]*sx_tmp[26];
sxdot_tmp[22] = p[3]*sx_tmp[25] - 1.0*p[4]*sx_tmp[22] + p[2]*sx_tmp[33] - 1.0*x_tmp[22];
sxdot_tmp[23] = p[2]*sx_tmp[28];
sxdot_tmp[24] = p[2]*sx_tmp[28] + 2.0*p[2]*sx_tmp[32];
sxdot_tmp[25] = 0.45*p[2]*sx_tmp[24] + p[2]*sx_tmp[26] - 1.0*p[3]*sx_tmp[25] + p[2]*sx_tmp[27];
sxdot_tmp[26] = p[2]*sx_tmp[12] + 0.55*p[2]*sx_tmp[24];
sxdot_tmp[27] = p[2]*sx_tmp[12] + p[0]*sx_tmp[34] + 0.45*p[2]*sx_tmp[32] - 1.0*sx_tmp[27]*(p[1] + p[3]);
sxdot_tmp[28] = p[0]*sx_tmp[9] - 1.0*p[1]*sx_tmp[28];
sxdot_tmp[29] = p[2]*sx_tmp[7] - 0.0002*sx_tmp[29];
sxdot_tmp[30] = p[2]*sx_tmp[11] - 1.0*p[0]*sx_tmp[30] + p[1]*sx_tmp[32] + 0.0002*sx_tmp[29];
sxdot_tmp[31] = p[1]*sx_tmp[12] - 1.0*p[0]*sx_tmp[31] + 0.55*p[2]*sx_tmp[30] + 0.0002*sx_tmp[0];
sxdot_tmp[32] = p[2]*sx_tmp[10] + p[0]*sx_tmp[30] - 1.0*p[1]*sx_tmp[32];
sxdot_tmp[33] = p[0]*sx_tmp[2] + p[3]*sx_tmp[27] - 1.0*sx_tmp[33]*(p[1] + p[4]) - 1.0*x_tmp[33];
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] + p[2]*sx_tmp[31] - 1.0*sx_tmp[34]*(p[0] + p[3]) + 0.0002*sx_tmp[3];
...
sxdot_tmp[34] = p[1]*sx_tmp[27] + 0.45*p[2]*sx_tmp[30] + p[2]*sx_tmp[31] - 1.0*sx_tmp[34]*(p[0] + p[3]) + 0.0002*sx_tmp[3];
 ...
 void sx0__sA_sPB_3o_2B_S_atS__T_atS__B_atS(int ip, N_Vector sx0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  int *plist = data->plist;
  ...
  switch (ip) {
  case 5: {
sx0_tmp[4] = (2.0*p[5] - 1.0)*(k[7] - 1.0);
sx0_tmp[5] = (k[8] - 1.0)*p[6];
sx0_tmp[6] = 1.0 - 1.0*k[0];
sx0_tmp[7] = - 1.0*(k[9] - 1.0)*(p[5] + p[6] - 1.0) - 1.0*(k[9] - 1.0)*p[5];
sx0_tmp[10] = (k[20] - 1.0)*(p[5] + p[6] - 1.0) + (k[20] - 1.0)*(p[5] + p[6]);
sx0_tmp[11] = -1.0*(k[15] - 1.0)*p[6];
sx0_tmp[28] = k[2] - 1.0;

  } break;

  case 6: {
sx0_tmp[5] = (k[8] - 1.0)*p[5];
sx0_tmp[7] = -1.0*(k[9] - 1.0)*p[5];
sx0_tmp[8] = (2.0*p[6] - 1.0)*(k[14] - 1.0);
sx0_tmp[9] = 1.0 - 1.0*k[1];
sx0_tmp[10] = (k[20] - 1.0)*(p[5] + p[6] - 1.0) + (k[20] - 1.0)*(p[5] + p[6]);
sx0_tmp[11] = - 1.0*(k[15] - 1.0)*(p[5] + p[6] - 1.0) - 1.0*(k[15] - 1.0)*p[6];
sx0_tmp[28] = k[2] - 1.0;
...
void y__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int nt, int it, double *y, double *p, double *k, double *u, double *x){
...
void dydp__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int nt, int it, double *dydp, double *y, double *p, double *k, double *u, double *x, int *plist, int np, int ny){
...
void dydx__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t,double *dydx, double *y, double *p, double *k, double *x){
...
void sy__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int nt, int it, int ip, int np, int nx, int ny, double *sy, double *p, double *k, double *x, double *sx){
  switch (ip) {
  case 0: {
...
int root__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, N_Vector x, realtype *gout, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double sroot__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int ip, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double s2root__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int ip, int jp, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double srootval__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int ip, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double s2rootval__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int ip, int jp, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
void deltadisc__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int idisc, N_Vector x, void *user_data){
  int ix;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
...
void sdeltadisc__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int idisc, N_Vector x, N_Vector *sx, void *user_data){
  int ix;
  int ip;
  UserData data = (UserData) user_data;
  int *plist = data->plist;
...
void dxdotdp__sA_sPB_3o_2B_S_atS__T_atS__B_atS(double t, int nt, int it, double *dxdotdp, double *p, double *k, double *u, double *x, int *plist, int np, int nx){
...
dxdotdp[(12+ip*nx)] = 0.55*x[it+nt*32];
...
dxdotdp[(25+ip*nx)] = 0.45*x[it+nt*24] + x[it+nt*26] + x[it+nt*27];
dxdotdp[(26+ip*nx)] = x[it+nt*12] + 0.55*x[it+nt*24];
dxdotdp[(27+ip*nx)] = x[it+nt*12] + 0.45*x[it+nt*32];
