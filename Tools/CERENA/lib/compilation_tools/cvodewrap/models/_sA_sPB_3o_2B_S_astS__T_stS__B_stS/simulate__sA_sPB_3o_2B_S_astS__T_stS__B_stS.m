% simulate__sA_sPB_3o_2B_S_astS__T_stS__B_stS.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_stS(tout,theta)
% [...] = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_stS(tout,theta,kappa,options)
% sol = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_stS(...)
% [status,tout,x,y,sx,sy] = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_stS(...)
%
% INPUTS:
% =======
...
function varargout = simulate__sA_sPB_3o_2B_S_astS__T_stS__B_stS(varargin)
...
cw__sA_sPB_3o_2B_S_astS__T_stS__B_stS(sol,tout,theta(1:11),kappa(1:70),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);
