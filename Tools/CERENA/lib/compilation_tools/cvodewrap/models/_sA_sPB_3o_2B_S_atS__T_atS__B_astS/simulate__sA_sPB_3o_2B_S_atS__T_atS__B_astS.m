% simulate__sA_sPB_3o_2B_S_atS__T_atS__B_astS.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate__sA_sPB_3o_2B_S_atS__T_atS__B_astS(tout,theta)
% [...] = simulate__sA_sPB_3o_2B_S_atS__T_atS__B_astS(tout,theta,kappa,options)
% sol = simulate__sA_sPB_3o_2B_S_atS__T_atS__B_astS(...)
% [status,tout,x,y,sx,sy] = simulate__sA_sPB_3o_2B_S_atS__T_atS__B_astS(...)
%
% INPUTS:
% =======
...
function varargout = simulate__sA_sPB_3o_2B_S_atS__T_atS__B_astS(varargin)
...
options_cvode.nnz = 116; % MUST NOT CHANGE THIS VALUE
...
rt = [7  10  29  24  19  20  14   5   6   8  30   1   4   2   9  12  31  32  35   3  11  33  13  28  34  25  27  26  23  18  21  16  22  17  15];
cw__sA_sPB_3o_2B_S_atS__T_atS__B_astS(sol,tout,theta(1:9),kappa(1:70),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);
