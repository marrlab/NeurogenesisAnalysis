% simulate__sA_sPB_3o_2B_S_stS__T_stS__B_dtS.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate__sA_sPB_3o_2B_S_stS__T_stS__B_dtS(tout,theta)
% [...] = simulate__sA_sPB_3o_2B_S_stS__T_stS__B_dtS(tout,theta,kappa,options)
% sol = simulate__sA_sPB_3o_2B_S_stS__T_stS__B_dtS(...)
% [status,tout,x,y,sx,sy] = simulate__sA_sPB_3o_2B_S_stS__T_stS__B_dtS(...)
%
% INPUTS:
% =======
...
function varargout = simulate__sA_sPB_3o_2B_S_stS__T_stS__B_dtS(varargin)
...
cw__sA_sPB_3o_2B_S_stS__T_stS__B_dtS(sol,tout,theta(1:10),kappa(1:70),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);
