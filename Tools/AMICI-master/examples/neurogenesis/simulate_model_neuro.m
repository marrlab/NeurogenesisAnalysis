% simulate_model_neuro.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_neuro(tout,theta)
% [...] = simulate_model_neuro(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_neuro(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_neuro(varargin)
...
sol = ami_model_neuro(tout,theta(1:7),kappa(1:0),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
    sol.sllh = sol.llhS;
    sol.sx = sol.xS;
    sol.sy = sol.yS;
